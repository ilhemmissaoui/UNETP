...
!(function () {
    ...
    function u(n, e, t) {
        if (t || 2 === arguments.length)
            for (var o, r = 0, i = e.length; r < i; r++)
                (!o && r in e) || ((o = o || Array.prototype.slice.call(e, 0, r))[r] = e[r]);
    ...
    function V(n) {
        for (var e = [], t = 0, o = n.length; t < o; ++t) {
            if (!D(n[t]))
                throw new Error('Arr.flatten item ' + t + ' was not an array, input: ' + n);
            hn.apply(e, n[t]);
        }
        return e;
    }
    ...
    function tn(n) {
        return (
            (1 !== n.nodeType && 9 !== n.nodeType && 11 !== n.nodeType) || 0 === n.childElementCount
        );
    }
    function on(n, e) {
    ...
    var ln,
        ...
        wn = {
            ...
            oses: w([
                ...
                { name: 'Linux', search: $('linux'), versionRegexes: [] },
                { name: 'Solaris', search: $('sunos'), versionRegexes: [] },
                { name: 'FreeBSD', search: $('freebsd'), versionRegexes: [] },
                {
                    name: 'ChromeOS',
                    search: $('cros'),
        ...
        Sn = 'Firefox',
        On = function () {
            return an({ current: void 0, version: bn.unknown() });
        },
        kn = an,
        ...
        Mn = 'ChromeOS',
        _n = function () {
            return sn({ current: void 0, version: bn.unknown() });
        },
        Rn = sn,
        Fn =
            (w(Tn),
    ...
    function je(n, e) {
        ...
        ze(n)
            ...
            : ((o = e), (r = Pe((t = n), 'class').concat([o])), Ie(t, 'class', r.join(' ')));
    }
    function Le(n, e) {
        var t, o, r, i;
        ze(n)
            ...
            : ((r = e),
              0 <
              (i = E(Pe((o = n), 'class'), function (n) {
                  return n !== r;
              })).length
                  ? Ie(o, 'class', i.join(' '))
                  : He(o, 'class')),
            0 === (ze((t = n)) ? t.dom.classList : Pe(t, 'class')).length && He(t, 'class');
    }
    function $e(n, e) {
    ...
    var Qt,
        ...
        ro = function (n, e) {
            return n.stype === Ue.Value ? { stype: Ue.Value, svalue: e(n.svalue) } : n;
        },
        io = function (n, e) {
            return n.stype === Ue.Error ? { stype: Ue.Error, serror: e(n.serror) } : n;
        },
        uo = vt,
        co = St(function (n, e) {
    ...
    function To(n) {
        if (!Re(n, 'can') && !Re(n, 'abort') && !Re(n, 'run'))
            throw new Error(
    ...
    function Co(n, e) {
        return { key: n, value: To({ abort: e }) };
    }
    function Eo(n, e) {
        return { key: n, value: To({ run: e }) };
    }
    function Do(n, t, o) {
        return {
            key: n,
    ...
    function zo(n) {
        return (
            void 0 === n && (n = fe.fromDom(document)), mn.from(n.dom.activeElement).map(fe.fromDom)
        );
    }
    function jo(e) {
    ...
    var Go,
            ...
            var c = De(e, function (n, e) {
                    return (
                        ...
                        (t.toFunctionAnnotation = function () {
                            return { name: o, parameters: Zo(f.slice(0, 1).concat(f.slice(3))) };
                        }),
                        t
                    );
        ...
        ur = w(void 0),
        cr = Ao({ fields: bo, name: 'swapping', apis: mt }),
                ...
                var c =
                        ...
                        (u = new Date().getTime()),
                        {
                            ...
                            write: function () {
                                ...
                                T(['mousemove', 'mouseover', 'mouseout', oe()], o) ||
                                    console.log(o, {
                                        event: o,
                                        time: n - u,
                                        target: r.dom,
                                        sequence: Z(i, function (n) {
                                            return T(['cut', 'stopped', 'response'], n.outcome)
                                                ? '{' +
                                                      n.purpose +
                                                      '} ' +
                                                      n.outcome +
    ...
    function Nr(n) {
        return ti.config({ channels: yo(mr, { onReceive: n }) });
    }
    function Hr(n, e) {
    ...
    function Xr(n, e) {
        var t,
            o = e;
        jr((t = n.dom)) && t.style.removeProperty(o),
            wo(Ae(n, 'style').map(yn), '') && He(n, 'style');
    }
    function qr(n) {
    ...
    var ni = w(lo(Sr())),
        ...
        si = Object.freeze({
            ...
            exhibit: function (n, e) {
                return Io(e.ignore ? {} : { attributes: { tabindex: '-1' } });
            },
            events: function (t) {
                return qo(
                    [
    ...
    function _i(n, e, t, o) {
        Mi(n, e, 0, [o]),
            Bi(0, e, 0, o) || (je(o.element, e.highlightClass), e.onHighlight(n, o), W(o, ce()));
    }
    function Ri(t, e, n, o) {
            ...
            schema: function () {
                return n.concat([
                    ...
                    Kt(
                        ...
                        'onFocus',
                        At(function (n) {
                            return T(['onFocus', 'onEnterOrSpace', 'onApi'], n)
                                ? ht.value(n)
                        ...
                        Eo(jn(), function (o, r) {
                            a(o, r, t, i, u).fold(
                                function () {
                                    ...
                                    i.focusInside === Pi.OnEnterOrSpaceMode &&
                                        n &&
                                        ko(e, t) &&
                                        c(i).each(function (n) {
                                            n(e, i, u), t.stop();
        ...
        return tr({
            readState: function () {
                return t
                    .get()
                    .map(function (n) {
                        return { numRows: String(n.numRows), numColumns: String(n.numColumns) };
                    })
    ...
    var Xu,
        ...
        ic = Zi(
            ...
            function (n, e, t, o) {
                var r = t.useSpace && !eu(n.element) ? Ui : [],
                    i = t.useEnter ? $i : [],
                    u = t.useDown ? Yi : [];
                return [Ci(Si(r.concat(i).concat(u)), ru)].concat(
                    t.useControlEnter ? [Ci(Oi([Ti, Si($i)]), ru)] : []
                );
            },
            function (n, e, t, o) {
        ...
        hc = Zi(
            [Lt('selector'), Yt('execute', tu), Tr('onEscape'), Yt('captureTab', !1), ei()],
            au,
            w([
                Ci(Si(Wi), lu(dc, mc)),
                Ci(Si(qi), du(dc, mc)),
        ...
        Tc = w([
            ...
            Ci(Si(Xi), sc(Oc)),
            Ci(Si(Yi), fc(kc)),
            Ci(Si(Ui.concat($i)), function (e, t, o) {
        ...
        Fc = Zi(
            ...
            function (n, e, t) {
                return [
                    Ci(Si(Ui), t.onSpace),
                    Ci(Oi([Ki, Si($i)]), t.onEnter),
                    Ci(Oi([ki, Si($i)]), t.onShiftEnter),
                    Ci(Oi([ki, Si(Li)]), t.onShiftTab),
                    Ci(Oi([Ki, Si(Li)]), t.onTab),
                    Ci(Si(Xi), t.onUp),
                    Ci(Si(Yi), t.onDown),
                    Ci(Si(Wi), t.onLeft),
                    Ci(Si(qi), t.onRight),
    ...
    function fa(n, e, t, o) {
        return co(e.defaults(n, t, o), t, { uid: n.partUids[e.name] }, e.overrides(n, t, o));
    }
    function la(n, e, t) {
        return (
            (o = e),
    ...
    function va(o) {
        return (
            (n = function (n) {
                ...
                return o.apply(void 0, u([n.getApis(), n], e, !1));
            }),
                ...
                M(e, function (n) {
                    n.fold(mn.some, mn.none, mn.some, mn.some).each(function (t) {
                        ...
                        i[t.name] = function (n) {
                            ...
                            return y(y({}, o), { config: n, validated: e });
                        };
                    });
                }),
                i),
    ...
    function Oa(n) {
        ...
        return (
            ...
            (o = R(
                ...
                function (n, e) {
                    var t;
                    return 'class' === e.name ? n : y(y({}, n), (((t = {})[e.name] = e.value), t));
                },
                {}
            )),
            (i = Array.prototype.slice.call(e.dom.classList, 0)),
            (u = 0 === t.length ? {} : { innerHtml: Lo(e) }),
            y({ tag: le(e), classes: i, attributes: o }, u)
        );
    }
    function ka(n) {
        return { dom: Oa(n) };
    ...
    function ks(r) {
        return function (n, e) {
            return (
                Ss(n, { x: (o = (0 < r ? ss : as)(is((t = e)).x, Na(t), ja(t), Ka(t))) }),
                mn.some(o).map(x)
            );
            var t, o;
        };
    ...
    function Ds(r) {
        return function (n, e) {
            return (
                Cs(n, { y: (o = (0 < r ? ss : as)(is((t = e)).y, Ha(t), La(t), Ka(t))) }),
                mn.some(o).map(x)
            );
            var t, o;
        };
        ...
        return function (n, e) {
            return (
                ...
                _s(
                    n,
                    Rs(
                        (i = (t = c) ? is(o).x : r(is(o).x, Na(o), ja(o), Ka(o))),
                        t ? r(is(o).y, Ha(o), La(o), Ka(o)) : is(o).y
                    )
                ),
                mn.some(i).map(x)
            );
            ...
            function () {
                return [
                    ...
                    $f.sketch({
                        ...
                        components: [
                            $f.parts['left-edge'](
                                ka('<div class="${prefix}-hue-slider-black"></div>')
                            ),
                            $f.parts.spectrum({
                            ...
                            $f.parts['right-edge'](
                                ka('<div class="${prefix}-hue-slider-white"></div>')
                            ),
                            $f.parts.thumb({
    ...
    var Hs = Wu(Jc.optional, ca),
        ...
        Ws = Gs(),
        Xs = function (n, e) {
            Object.defineProperty(n.dom, Ws, { value: e, writable: !0 });
        },
        qs = Gu,
        Ys = function (n) {
            return dt(n, 'uid') ? n : y(y({}, n), { uid: qs('uid') });
        },
        Ks = It([
            Lt('name'),
            Lt('factory'),
        ...
        Qs = wa({
            ...
            factory: function (n) {
                ...
                return {
                    ...
                    events: o,
                    behaviours: $c(n.buttonBehaviours, [
                        fi.config({}),
                        jc.config({ mode: 'execution', useSpace: !0, useEnter: !0 })
                    ]),
                    domModification: {
                        attributes: (function () {
        ...
        ef = Hs({ schema: [Lt('dom')], name: 'label' }),
        tf = Da('top-left'),
        of = Da('top'),
        rf = Da('top-right'),
        uf = Da('right'),
            ...
            $t(
                ...
                jt('mode', {
                    ...
                    xy: [
                        ...
                        Yt('maxY', 100),
                        vo('value', function (n) {
                            return No({ x: n.mode.minX, y: n.mode.minY });
                        }),
                        Lt('getInitialValue'),
                        Dr('manager', zf)
                    ]
            ...
            factory: function (i, n, e, t) {
                ...
                return {
                    ...
                    behaviours: Lu(i.sliderBehaviours, [
                        ...
                        ti.config({ channels: (((p = {})[Lf()] = { onReceive: d }), p) })
                    ]),
                    events: qo([
                        Eo(xf(), function (n, e) {
                            !(function (n, e) {
    ...
    function rl(n, e) {
        var t = Ns(
                rd.sketch({
                    inputAttributes: { placeholder: cd.translate(e) },
                    onSetValue: function (n, e) {
                        W(n, $n());
                    },
                    inputBehaviours: or([
                        ed.config({ find: mn.some }),
                        ud.config({}),
                        jc.config({ mode: 'execution' })
                    ]),
                    selectOnFocus: !1
                })
            ),
    ...
    function vl(n) {
        ...
        return (
            ...
            })),
            {
                list: o,
                data: De(
                    Ht('component.behaviours', lo(r), e.behaviours).fold(function (n) {
        ...
        var o,
            ...
            c =
                0 < e.length
                    ...
                    : u;
        return y(y({}, (r = i)), {
            attributes: y(y({}, r.attributes), c.attributes),
            styles: y(y({}, r.styles), c.styles),
    ...
    function Sl(n) {
        (jo(n.element).isNone() || fi.isFocused(n)) &&
            (fi.isFocused(n) || fi.focus(n), X(n, Ed, { item: n }));
    }
    function Ol(n) {
        X(n, Dd, { item: n });
    }
    ...
    function Ml(n, e, t, o) {
        Dl(n, e, t),
            Ne(n.element, e.stateAttr) && Be(n.element, e.stateAttr) !== o && e.onFinish(n, o),
            Ie(n.element, e.stateAttr, o);
    }
    function _l(n) {
        je(n, Qd);
    }
    ...
    function Vl(t, n, o) {
                ...
                (i = (r = function (n) {
                    return B(n, function (n) {
                        return void 0 === n.items
                            ? !Re(n, 'format') || e.formatter.canApply(n.format)
                                ? [n]
                                : []
                            : 0 < r(n.items).length
                            ? [n]
        ...
        return (
            ...
            (l = co(f, yo('styles', s))),
            (d = { tmenu: Wd.tieredData('styles', l, c.expansions) }),
            (m = Ns(
                Wd.sketch({
                    ...
                    onOpenSubmenu: function (n, e, t) {
                        ...
                        Va(t.element, o),
                            Jd.progressTo(i, 'before'),
                            Jd.jumpTo(t, 'after'),
                            Jd.progressTo(t, 'current');
                    },
        ...
        var c,
            ...
            b = (a = function (n) {
                return Z(n, function (n) {
                    if (Re(n, 'items')) {
                        var e = a(n.items);
                        return co(co(n, { isSelected: S, getPreview: w('') }), { items: e });
                    }
                    return Re(n, 'format')
                        ? co(n, { isSelected: y(n.format), getPreview: x(n.format) })
                        : ((o = Gu((t = n).title)),
                          (r = co(t, { format: o, isSelected: y(o), getPreview: x(o) })),
            ...
            styleselect: u(mn.none(), function () {
                return nf(
                    ...
                    or([
                        ...
                        ti.config({ channels: xo([Hr(mr, ii.off), Hr(gr, ii.off)]) })
                    ]),
                    r
                );
            })
    ...
    function Hl(n, e, t, o, r) {
        ...
        return n.dom.addEventListener(e, c, r), { unbind: J(rm, n, e, c, r) };
    }
    function Pl(n, e, t) {
        ...
        var n = fe.fromDom(o),
            ...
            i = function (n) {
                ...
                r = um.setInterval(function () {
                    e !== o.innerHeight
                        ? (um.clearInterval(r), n(mn.some(o.innerHeight)))
                        : 20 < t && (um.clearInterval(r), n(mn.none())),
                        t++;
                }, 50);
            };
        return {
    ...
    !(function () {
        ...
        'object' == typeof qf && void 0 !== Yf
            ? (Yf.exports = e())
            : ((n = 'undefined' != typeof globalThis ? globalThis : n || self).EphoxContactWrapper =
                  e());
    })();
    function ql(r, n) {
        return {
    ...
    var Kl,
        ...
        ed = Ao({ fields: [Lt('find')], name: 'composing', apis: nd }),
        td = wa({
            name: 'Container',
            factory: function (n) {
                var e = n.dom,
                ...
                return {
                    uid: n.uid,
                    dom: y({ tag: 'div', attributes: y({ role: 'presentation' }, t) }, o),
                    components: n.components,
        ...
        od = wa({
            ...
            factory: function (t) {
                return {
                    uid: t.uid,
                    dom: t.dom,
                    behaviours: $c(t.dataBehaviours, [
                        hf.config({ store: { mode: 'memory', initialValue: t.getInitialValue() } }),
                        ed.config({ find: mn.some })
                    ]),
                    events: qo([
                        Yo(function (n, e) {
        ...
        rd = wa({
            ...
            factory: function (n, e) {
                return {
                    ...
                    dom: {
                        tag: (o = n).tag,
                        attributes: y({ type: 'text' }, o.inputAttributes),
        ...
        id = Object.freeze({
            __proto__: null,
            exhibit: function (n, e) {
                return Io({ attributes: xo([{ key: e.tabAttr, value: 'true' }]) });
            }
        }),
        ud = Ao({ fields: [Yt('tabAttr', 'data-alloy-tabstop')], name: 'tabstopping', active: id }),
        ...
        dd = Object.freeze({
            __proto__: null,
            exhibit: function (n, e) {
                return Io({ classes: e.disabled() ? e.disableClass.toArray() : [] });
            },
            events: function (t, n) {
                return qo([
                    Co(Zn(), function (n, e) {
                    ...
                    e = {
                        field: function (n, e) {
                            return (
                                ...
                                (t = al(n)),
                                (o = e),
                                { uiType: Yc(), owner: 'form', name: t, config: o, validated: {} }
                            );
                            var t, o;
                        },
                        record: w((r = []))
            ...
            return [
                {
                    ...
                    items: [
                        ((n = {
                            fields: [
                                rl('url', 'Type or paste URL'),
                                rl('text', 'Link text'),
                                rl('title', 'Link title'),
                                rl('target', 'Link target'),
                                {
                                    name: 'link',
                                    spec: od.sketch({
                        ...
                        (s = zt(
                            ...
                            lo([
                                ...
                                Lt('getInitialValue'),
                                vo('state', function () {
                                    return { dialogSwipeState: cu(), currentScreen: No(0) };
                                })
                            ]),
                            n
                        )),
                                            ...
                                            hi(n.element, '.' + ci('serialised-dialog-chain')).each(
                                                function (n) {
                                                    $r(
                                                        n,
                                                        'left',
                                                        -s.state.currentScreen.get() * t.width +
                                                            'px'
                                                    );
                                                }
                                            );
        ...
        bd = Object.freeze({ __proto__: null, events: vd }),
        yd = K,
        xd = fl(),
        wd = function (n, c) {
            var e,
                ...
                u,
                a = Me(n, function (r, u) {
                    return (1 === r.length ? ht.value(r[0].handler) : gl(r, c, u)).map(function (
                        n
                    ) {
                        var e,
                            i,
                            ...
                            o =
                                1 < r.length
                                    ...
                                    : r[0].name;
                        return yo(u, { handler: t, purpose: o });
                    });
                });
            return (
                (e = {}),
        ...
        Od = lo([
            ...
            ho(
                'eventOrder',
                'eventOrder',
                (((Kl = {})[Zn()] = ['disabling', Sd, 'toggling', 'typeaheadevents']),
                (Kl[Yn()] = [Sd, 'focusing', 'keying']),
                (Kl[oe()] = [Sd, 'disabling', 'toggling', 'representing']),
                (Kl[$n()] = [Sd, 'representing', 'streaming', 'invalidating']),
                (Kl[ie()] = [Sd, 'representing', 'item-events', 'tooltipping']),
                (Kl[Nn()] = ['focusing', Sd, 'item-type-events']),
                (Kl[Vn()] = ['focusing', Sd, 'item-type-events']),
                (Kl[zn()] = ['item-type-events', 'tooltipping']),
                (Kl[Qn()] = ['receiving', 'reflecting', 'tooltipping']),
                Et(w(Kl))),
                mo()
            ),
            Ut('domModification')
        ...
        Td = function (u) {
            return _e(u, Ls).getOrThunk(function () {
                var n,
                    ...
                    o,
                    r,
                    i = dt(u, 'uid') ? u : y({ uid: kd('') }, u);
                return (
                    (n = yd(i)),
                    (e = n.events),
                    (t = c(n, ['events'])),
                    (o = Z(_e(t, 'components').getOr([]), Td)),
                    (r = y(y({}, t), { events: y(y({}, bd), e), components: o })),
        ...
        Rd = [
            ...
            Yt('hasSubmenu', !1),
            Ut('toggling'),
            Lc('itemBehaviours', [ii, fi, jc, hf]),
            Yt('ignoreFocus', !1),
            Yt('domModification', {}),
            Dr('builder', function (n) {
                return {
                    dom: n.dom,
                    domModification: y(y({}, n.domModification), {
                        attributes: y(
                            y(
                                y(
                    ...
                    behaviours: $c(n.itemBehaviours, [
                        n.toggling.fold(ii.revoke, function (n) {
                            return ii.config(y({ aria: { mode: 'checked' } }, n));
                        }),
                        fi.config({
                        ...
                        jc.config({ mode: 'execution' }),
                        hf.config({ store: { mode: 'memory', initialValue: n.data } }),
                        el(
                            'item-type-events',
                            u(u([], Pr(), !0), [Eo(zn(), Sl), Eo(ne(), fi.focus)], !1)
                        )
                    ]),
                    components: n.components,
                    eventOrder: n.eventOrder
        ...
        Bd = jt('type', {
            widget: [
                ...
                Dr('builder', function (t) {
                    ...
                    function n(n, e) {
                        return (
                            eu(e.event.target) || (t.autofocus && e.setSource(n.element)), mn.none()
                        );
                    }
                    var e = la(Id(), t, Vd()),
                    ...
                    return {
                        ...
                        behaviours: $c(t.widgetBehaviours, [
                            hf.config({ store: { mode: 'memory', initialValue: t.data } }),
                            fi.config({
        ...
        Ad = w([
            Ps({
                ...
                defaults: function (n, e) {
                    return dt(e, 'uid') ? e : y(y({}, e), { uid: qs('item') });
                },
            ...
            factory: function (n, e, t, o) {
                return {
                    ...
                    behaviours: Lu(n.menuBehaviours, [
                        ...
                        hf.config({ store: { mode: 'memory', initialValue: n.value } }),
                        ed.config({ find: mn.some }),
                    ...
                    events: qo([
                        Eo(_d(), function (e, t) {
                            ...
                            e.getSystem()
                                .getByDom(n.target)
                                .each(function (n) {
                                    Qi.highlight(e, n), t.stop(), X(e, Hd(), { menu: e, item: n });
                                });
                        }),
                        Eo(Md(), function (n, e) {
                            var t = e.event.item;
        ...
        $d = function () {
            ...
            return {
                setMenuBuilt: function (n, e) {
                    var t;
                    u.set(y(y({}, u.get()), (((t = {})[n] = { type: 'prepared', menu: e }), t)));
                },
        ...
        Wd = wa({
            ...
            configFields: [
                ...
                Gt('data', [Lt('primary'), Lt('menus'), Lt('expansions')]),
                Yt('fakeFocus', !1),
                kr('onHighlight'),
                kr('onHover'),
                Gt('markers', [Lt('backgroundMenu')].concat(wr()).concat(Sr())),
                Lt('dom'),
                Yt('navigateOnHover', !0),
                Yt('stayInDom', !1),
                ju('tmenuBehaviours', [jc, Qi, ed, jd]),
                Yt('eventOrder', {})
            ],
            apis: {
            ...
            factory: function (c, n) {
                ...
                function f(n, o) {
                    ...
                    Ee(
                        ...
                        r.get().getOrThunk(function () {
                            ...
                            return (
                                M(
                                    E(Jr(e.element, '.' + c.markers.item), function (n) {
                    ...
                    return mn.from(r[0]).bind(function (n) {
                        return o.lookupMenu(n).bind(function (n) {
                            ...
                            return (
                                ...
                                rt(e.element) || jd.append(t, Cd(e)),
                                hl(e.element, [c.markers.backgroundMenu]),
                                i(t, e),
                                s(t, o, r),
                                mn.some(e)
                            );
                ...
                function g(r, i, u) {
                    if (
                        ...
                        i.hasConfigured(md) && md.isDisabled(i))
                    )
                        return mn.some(i);
                    var n = a(i);
                        ...
                        return (
                            ...
                            mn.from(o[0]).bind(function (t) {
                                return m.lookupMenu(t).bind(function (n) {
                                    ...
                                    return (
                                        rt(e.element) || jd.append(r, Cd(e)),
                                        c.onOpenSubmenu(r, i, e, N(o)),
            ...
            extraApis: {
                ...
                singleData: function (n, e) {
                    return { primary: n, menus: yo(n, e), expansions: {} };
                },
                collapseItem: function (n) {
                    return { value: Gu(Ud()), meta: { text: n } };
                }
            }
        }),
        Xd = function (n, e, t, o) {
        ...
        Yd = Object.freeze({
            ...
            progressTo: function (t, o, r, i) {
                var e,
                    u = o;
                Ne((e = t).element, u.destinationAttr) &&
                            ...
                            El(0, r, 0, e).each(function (n) {
                                n.transition.each(function (n) {
                                    o.propertyName === n.property &&
                                        (Ml(t, r, i, e.destination), r.onTransition(t, e));
                                });
                            });
                        });
                    }),
            ...
            fields: [
                ...
                $t(
                    ...
                    Nt(
                        ...
                        Nt(
                            ht.value,
                            It([qt('transition', [Lt('property'), Lt('transitionClass')])])
                        )
                    )
                )
            ],
        ...
        Qd = ci('scrollable'),
        Zd = Qd,
        nm = function (n, e, t, o, r) {
            return {
                data: { value: n, text: e },
                type: 'item',
                dom: { tag: 'div', classes: r ? [ci('styles-item-is-menu')] : [] },
                toggling: { toggleOnExecute: !1, toggleClass: ci('format-matches'), selected: t },
                itemBehaviours: or(
                    r
                        ? []
                        : [
                ...
                components: [{ dom: { tag: 'div', attributes: { style: o }, innerHtml: e } }]
            };
        },
        em = function (n, e, t, o) {
            return {
                ...
                components: [
                    ...
                    }),
                    {
                        ...
                        behaviours: or([
                            el('adhoc-scrollable-menu', [
                                Yo(function (n, e) {
                                    $r(n.element, 'overflow-y', 'auto'),
                                        $r(n.element, '-webkit-overflow-scrolling', 'touch'),
                                        _l(n.element);
                                }),
                                Ko(function (n) {
                ...
                menuBehaviours: or([
                    Jd.config({
                        ...
                        routes: Jd.createTristate('before', 'current', 'after', {
                            transition: { property: 'transform', transitionClass: 'transitioning' }
                        })
                    })
                ])
            };
    ...
    function mm(n) {
        ...
        return (
            ...
            (f = s),
            (l = un(e, o) && t === r),
            f.collapsed && !l ? mn.some(fg(d, n.anchorOffset, m, n.focusOffset)) : dm(n)
        );
    }
    function gm(n) {
        return sm(n)
    ...
    function pm(n, e) {
        ...
        return 0 < (o = 0 < r.length ? r[0] : t.getBoundingClientRect()).width || 0 < o.height
            ? mn.some(o).map(Ul)
            : mn.none();
    }
    function hm(n) {
    ...
    function wm() {
        ...
        return {
            ...
            restore: function () {
                null != t && 0 < t.length
                    ? Ie(n, 'content', t)
                    : Ie(n, 'content', 'user-scalable=yes');
            }
        };
    }
    function Sm(n, e) {
                  ...
                  if (o.collapsed) {
                      ...
                      return pe(r)
                          .bind(function (n) {
                              ...
                              return pm(o.startContainer.ownerDocument.defaultView, t)
                                  .map(Dm)
                                  .map(P);
                          })
                          .getOr([]);
    ...
    function Im(o, r) {
        var i = fe.fromDom(r.document.body),
            n = Pl(fe.fromDom(o), 'resize', function () {
                ...
                (n = o),
                    (e = Em(i, Sg)),
                    ((t = n.innerHeight) < e ? mn.some(e - t) : mn.none()).each(function (t) {
                        var n;
                        (0 < (n = _m(r)).length ? mn.some(n[0]).map(Fm) : mn.none()).each(function (
                            n
                        ) {
                            var e =
        ...
        var s,
            ...
            c =
                ...
                (f = uu()),
                {
                    enter: function () {
                        r.hide(),
                            je(s.container, ci('fullscreen-maximized')),
                            je(s.container, ci('android-maximized')),
                            i.maximize(),
                            je(s.body, ci('android-scroll-reload')),
                            u.set(Im(s.win, hg(s.editor).getOrDie('no'))),
                            xm(s.editor).each(function (n) {
                                function e(n) {
                                ...
                                Sm(s.container, n.body),
                                    f.set(
                                        ...
                                        (c = me(r)),
                                        (a = [
                                            Pl(o.body, 'touchstart', function (n) {
                                                o.onTouchContent(), u.fireTouchstart(n);
                                            }),
                                            u.onTouchmove(),
                                            u.onTouchend(),
                                            Pl(r, 'touchstart', function (n) {
                                                o.onTouchToolstrip();
                                            }),
                                            ...
                                            1 == wg
                                                ? []
                                                : [
                                                      Pl(fe.fromDom(o.win), 'blur', function () {
                                                          i.getByDom(r).each(ii.off);
                                                      }),
                                                      Pl(c, 'select', t),
                                                      Pl(o.doc, 'selectionchange', t)
                                                  ]
                                        )),
                                        {
                                            destroy: function () {
    ...
    function Hm() {
        function e(n) {
            ...
            return {
                ...
                tgroupBehaviours: or([
                    el(
                        ...
                        !0 === n.scrollable
                            ? [
                                  Jo(function (n, e) {
                                      $r(n.element, 'overflow-x', 'auto'),
                                          Ie(n.element, Rg, 'true'),
                                          _l(n.element);
                                  })
                              ]
                            : []
                ...
                components: [td.sketch({ components: [_g.parts.items({})] })],
    ...
    function qm(n, e, t, o) {
        t.setCollapsed(),
            $r(n.element, $m(e), Gm(e, n.element)),
            qr(n.element),
            Um(n, e),
            Wm(n, e),
            e.onStartShrink(n),
        ...
        return a.fold(
            ...
            function (e) {
                ...
                return (
                    dl(t)(s),
                    s.isStopped()
                        ? (i.logEventStopped(o, e.element, t.purpose), Bg.stopped())
                        : s.isCut()
                        ? (i.logEventCut(o, e.element, t.purpose), Bg.complete())
                        : pe(e.element).fold(
                              function () {
    ...
    var cg,
        ...
        dg = Jt([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
        mg = {
            before: dg.before,
            on: dg.on,
            after: dg.after,
        ...
        kg = lo([
            Gt('editor', [
                ...
                Yt('onScrollToCursor', Og),
                Yt('onScrollToElement', Og),
                Yt('onToEditing', Og),
                Yt('onToReading', Og),
        ...
        Cg = w([
            Hs({
                name: 'groups',
                overrides: function () {
                    return { behaviours: or([jd.config({})]) };
                }
            })
        ]),
        Eg = Sa({
            ...
            factory: function (o, n, e, t) {
                var r = o.shell
                    ? { behaviours: [jd.config({})], components: [] }
            ...
            factory: function (n, e, t, o) {
                return {
                    ...
                    behaviours: Lu(n.tgroupBehaviours, [
                        jc.config({ mode: 'flow', selector: n.markers.itemSelector })
                    ]),
        ...
        Fg = Object.freeze({
            ...
            refresh: function (n, e, t) {
                var o;
                t.isExpanded() &&
                    (Xr(n.element, $m(e)), (o = Gm(e, n.element)), $r(n.element, $m(e), o));
            },
            grow: function (n, e, t) {
            ...
            exhibit: function (n, e, t) {
                return Io(
                    e.expanded
                        ...
                        : { classes: [e.closedClass], styles: yo(e.dimension.property, '0px') }
                );
            },
            events: function (t, o) {
                return qo([
        ...
        Bg = Jt([{ stopped: [] }, { resume: ['element'] }, { complete: [] }]),
        Ag = function (e, t, o, n, r, i) {
            return og(e, t, o, n, r, i).fold(
                x,
                function (n) {
            ...
            var i = ig(),
                ...
                g = function (n) {
                    return i.getById(n).fold(function () {
                        return ht.error(
                            new Error('Could not find component with uid: "' + n + '" in system.')
                        );
                    }, ht.value);
                },
                p = function (n) {
    ...
    function zg(n) {
        var e = Td(
            td.sketch({
                ...
                containerBehaviours: or([cr.config({ alpha: Hg, omega: Pg })])
            })
        );
        return Ng(e);
    }
    function jg(n, e) {
        ...
        Gr(t, { opacity: '0', position: 'absolute', top: '-1000px', left: '-1000px' }),
            Qe(n, t),
            Ho(t),
            e(t),
            Ze(t);
    ...
    function tp(r, i) {
        return ap(function (n) {
            ...
            pp.animate(
                ...
                o,
                function (n, e) {
                    Em(r, hp) !== r.dom.scrollTop
                        ? e(r.dom.scrollTop)
                        : ((r.dom.scrollTop = n), Ie(r, hp, n));
                },
                function () {
    ...
    function yp(n) {
        var o,
            ...
            M =
                ...
                (d = Be((l = i), 'style')),
                Gr(l, { position: 'absolute', top: '0px' }),
                Ie(l, lp, '0px'),
                Ie(l, dp, 'top'),
                (g = {
                    restore: function () {
                ...
                (f = Be((s = o), 'style')),
                _l(s),
                Gr(s, { position: 'absolute', height: a + 'px', width: '100%', top: c + 'px' }),
                Ie(s, lp, c + 'px'),
                Ie(s, mp, 'true'),
                Ie(s, dp, 'top'),
                (v = {
                ...
                (t = Be((e = u), 'style')),
                Gr(e, { position: 'absolute', bottom: '0px' }),
                Ie(e, lp, '0px'),
                Ie(e, dp, 'bottom'),
                (b = {
                    restore: function () {
            ...
            _ = T(D, x, ke(), k),
            R = Ll(C, { onChange: Y, onReady: M.refresh });
        function F() {
            var n = m.innerHeight;
            return Em(o, gp) < n;
        }
        ...
        var B,
            ...
            X =
                ...
                (U = Pl(fe.fromDom(H), 'scroll', function () {
            ...
            q = (function (e, t) {
                ...
                function r(n) {
                    ...
                    return (
                        pl(e, [ci('layer-editor'), ci('unfocused-selection')]),
                        Gr(e, {
                            left: n.left + 'px',
                            top: n.top + 'px',
                            width: n.width + 'px',
        ...
        return {
            ...
            scrollIntoView: function (n, e) {
                var t,
                    ...
                    c = J(Lg, o);
                u < r || u < i
                    ? tp(t, t.dom.scrollTop - u + i).get(c)
                    : r < 0 && tp(t, t.dom.scrollTop + r).get(c);
            },
            ...
            enter: function () {
                ...
                xm(g.editor).each(function (n) {
                    ...
                    h.set({
                        ...
                        je(g.container, ci('fullscreen-maximized')),
                        Sm(g.container, n.body),
                        p.maximize(),
                        $r(g.socket, 'overflow', 'scroll'),
                        $r(g.socket, '-webkit-overflow-scrolling', 'touch'),
                        Ho(n.body),
                        b.set(
                            yp({
                                cWin: n.win,
        ...
        return {
            ...
            renderUI: function () {
                var n,
                    ...
                    o = {
                        content:
                            (n = mn.from(E.getParam('skin_url')).getOrThunk(function () {
                ...
                var i,
                    ...
                    w = Fn().os.isAndroid()
                        ? ((i = r),
                          (u = zg({ classes: [ci('android-container')] })),
                          (c = Hm()),
                          (a = uu()),
                          (s = Pm(a)),
                          (f = zm()),
                              ...
                              init: function (r) {
                                  h.set(
                                      (function () {
                                          ...
                                          $r(n.toolstrip, 'width', '100%'),
                                              $r(n.container, 'position', 'relative');
                                          var e = Td(
                                              Bm(function () {
                ...
                return (
                    E.on('init', function () {
                        w.init({
                            editor: {
                                getFrame: function () {
                                    return fe.fromDom(
                                        E.contentAreaContainer.querySelector('iframe')
                                    );
                                },
                                ...
                                onScrollToCursor: function (e) {
                                    return (
                                        E.on('ScrollIntoView', function (n) {
                                            e(n);
                                        }),
                                        {
                                            unbind: function () {
                                ...
                                onTouchContent: function () {
                                    jo(
                                        fe.fromDom(
                                            E.editorContainer.querySelector('.' + ci('toolbar'))
                                        )
                                    )
                                        .bind(function (n) {
                                ...
                                onTapContent: function (n) {
                                    var e = n.target;
                                    'img' === le(e)
                                        ? (E.selection.select(e.dom), n.kill())
                                        : 'a' === le(e) &&
                                          w.system
                                              .getByDom(fe.fromDom(E.editorContainer))
                                              .each(function (n) {
                                                  cr.isAlpha(n) &&
                                                      (function (n) {
                            ...
                            toolstrip: fe.fromDom(
                                E.editorContainer.querySelector('.' + ci('toolstrip'))
                            ),
                            toolbar: fe.fromDom(
                                E.editorContainer.querySelector('.' + ci('toolbar'))
                            ),
                        ...
                        var t,
                            ...
                            f = No([
                                {
                                    ...
                                    items:
                                        ((t = a),
                                        (e = E.getParam('toolbar', lr, 'array')),
                                        (n = (D(e) ? om : Bl)(e)),
                                        (o = {}),
                                        B(n, function (n) {
                                            var e =
                                                !Re(o, n) && Re(t, n) && t[n].isSupported()
                                                    ? [t[n].sketch()]
                                                    : [];
                                            return (o[n] = !0), e;
                                        }))
                            ...
                            l = No([
                                { label: 'The read only mode group', scrollable: !0, items: [] },
                                s
                            ]),
                            d = No({ backToMask: [u], backToReadOnly: [c] }),
                            m = w;
                    ...
                    { iframeContainer: w.socket.element.dom, editorContainer: w.element.dom }
                );
            }
        };
    });
