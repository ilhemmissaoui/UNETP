...
!(function () {
    ...
    var m = function (e) {
        ...
        p = m(function (e, t) {
            ...
            return (
                n === r(t) &&
                (-1 !==
                ['undefined', 'boolean', 'number', 'string', 'function', 'xml', 'null'].indexOf(n)
                    ? e === t
                    : 'array' === n
                    ? f(p).eq(e, t)
                    : 'object' === n && d(p).eq(e, t))
    ...
    var Xe = function (e, t) {
        ...
        Et = {
            ...
            create: function (e, t, n) {
                ...
                if (!c[s]) {
                    if ('static' === e[2])
                        return (c[s] = t), void (this.onCreate && this.onCreate(e[2], e[3], c[s]));
    ...
    !(function () {
        ...
        'object' == typeof er && void 0 !== tr
            ? (tr.exports = t())
            : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).EphoxContactWrapper =
                  t());
    })();
    function rr(e) {
        return sr(function () {
    ...
    function vr(e, t) {
        return (
            ...
            He((r = void 0 === e ? document : e.dom))
                ? ve.none()
                : ve.from(r.querySelector(n)).map(Nt.fromDom)
        );
        var n, r;
    }
    function br(e, t, n) {
    ...
    var Sr,
        ...
        Rr =
            ...
            (Dr.prototype.next = function (e) {
                return (
                    (this.node = this.findSibling(this.node, 'firstChild', 'nextSibling', e)),
                    this.node
                );
            }),
    ...
    function Fr(e) {
        ...
        return (
            !!jn(t) &&
            (t.data.charAt(e.offset()) === Co || (e.isAtStart() && Lr(t.previousSibling)))
        );
    }
    function Ur(e) {
        var t = e.container();
        return (
            !!jn(t) && (t.data.charAt(e.offset() - 1) === Co || (e.isAtEnd() && Lr(t.nextSibling)))
        );
    }
    function zr(e) {
                ...
                !1 ===
                    ...
                    jn((i = e)) &&
                        ...
                        !1 ===
                            ((n = i),
                            (r = Nt.fromDom(a)),
                            hr(Nt.fromDom(n), 'pre,code', A(je, r)).isSome()))) ||
            (zn((o = e)) &&
                'A' === o.nodeName &&
                !o.hasAttribute('href') &&
    ...
    function Xr(e) {
        return (
            'span' === e.nodeName.toLowerCase() && 'bookmark' === e.getAttribute('data-mce-type')
        );
    }
    function Yr(e, t) {
        var n,
    ...
    function to(i) {
        function e(e, t, n) {
            ...
            return (
                r
                    ? (r = Zo(r, /[, ]/, Zo(r.toUpperCase(), /[, ]/)))
                    : (r = Jo[e]) ||
                      ((r = Zo(t, ' ', Zo(t.toUpperCase(), ' '))), (r = ti(r, n)), (Jo[e] = r)),
                r
            );
        }
        var t,
            ...
            m =
                ...
                Jo[t] ||
                    ...
                    g(
                        'table',
                        'border',
                        'caption colgroup thead tfoot tbody tr' + ('html4' === t ? ' col' : '')
                    ),
                    g('colgroup', 'span', 'col'),
                    g('col', 'span'),
        ...
        ei(
            (i.special || 'script noscript iframe noframes noembed title style textarea xmp').split(
                ' '
            ),
            function (e) {
                d[e] = new RegExp('</' + e + '[^>]*>', 'gi');
            ...
            i.valid_elements
                ? B(i.valid_elements)
                : (ei(m, function (e, t) {
                      (S[t] = { attributes: e.attributes, attributesOrder: e.attributesOrder }),
                          (l[t] = e.children);
                  }),
                  'html5' !== i.schema &&
                  ...
                  ei(
                      Zr('ol ul sub sup blockquote span font a table tbody strong em b i'),
                      function (e) {
        ...
        return {
            ...
            parse: function (e) {
                ...
                function a(e, t, n, r, o, i) {
                    ...
                    return (
                        "url('" + (t = h ? h.call(v, t, 'style') : t).replace(/\'/g, "\\'") + "')"
                    );
                }
                var s,
                    c,
    ...
    function io(e, t, n, r) {
        ...
        return (
            ...
            (K((i = t).preventDefault) || oo(i)) &&
                ...
                a.isDefaultPrevented !== w &&
                    a.isDefaultPrevented !== R &&
                    ((a.isDefaultPrevented = !0 === a.defaultPrevented ? w : R),
        ...
        ai =
            ...
            (ui.prototype.clean = function (e) {
                ...
                if (
                    ...
                    for (this.unbind(e), t = (n = e.getElementsByTagName('*')).length; t--; )
    ...
    var aa = function (e, t, n, r) {
        ...
        if (
            ((t ? t.ownerDocument || t : _i) !== Ci && yi(t),
            (n = n || []),
            !e || 'string' != typeof e)
        )
            return n;
            ...
            if ((o = na.exec(e)))
                if ((a = o[1])) {
                    ...
                    if ((a = o[3]) && ci.getElementsByClassName)
                        return Ui.apply(n, t.getElementsByClassName(a)), n;
                }
    ...
    (ci = aa.support = {}),
                                          ...
                                          (1 &
                                              (n =
                                                  (e.ownerDocument || e) === (t.ownerDocument || t)
                                                      ...
                                                      : 1) ||
                                          (!ci.sortDetached && t.compareDocumentPosition(e) === n)
        ...
        (aa.uniqueSort = function (e) {
            var t,
                ...
                o = 0;
            if (
                ((bi = !ci.detectDuplicates), (vi = !ci.sortStable && e.slice(0)), e.sort(Bi), bi)
            ) {
                ...
                filter: {
                    ...
                    PSEUDO: function (e, i) {
                        var t,
                            a =
                                li.pseudos[e] ||
                                li.setFilters[e.toLowerCase()] ||
                                aa.error('unsupported pseudo: ' + e);
                        return a[ki]
                            ? a(i)
                            : 1 < a.length
                            ? ((t = [e, e, '', i]),
        ...
        (mi = aa.tokenize =
            function (e, t) {
                ...
                for (a = e, u = [], s = li.preFilter; a; ) {
                    for (i in ((n && !(r = Ki.exec(a))) ||
                        (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
                    (n = !1),
                    (r = Xi.exec(a)) &&
                        ((n = r.shift()),
                        o.push({ value: n, type: r[0].replace(Wi, ' ') }),
                        (a = a.slice(n.length))),
                    li.filter))
                        li.filter.hasOwnProperty(i) &&
                            (!(r = Qi[i].exec(a)) ||
                                (s[i] && !(r = s[i](r))) ||
                                ((n = r.shift()),
        ...
        (gi = aa.compile =
            function (e, t) {
                ...
                if (!i) {
                    ...
                    (i = Oi(
                        e,
                        ((h = o), (b = 0 < (v = r).length), (y = 0 < h.length), b ? sa(a) : a)
                    )).selector = e;
                }
            ...
            function (e, t, n, r) {
                ...
                if (((n = n || []), 1 === l.length)) {
                    if (
                        ...
                        9 === t.nodeType &&
                        wi &&
                        li.relative[i[1].type]
                    ) {
                        if (!(t = (li.find.ID(a.matches[0].replace(ia, si), t) || [])[0])) return n;
                        c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
                    }
                    for (
                        o = Qi.needsContext.test(e) ? 0 : i.length;
                        o-- && ((a = i[o]), !li.relative[(u = a.type)]);

                    )
                        if (
                            (s = li.find[u]) &&
                            (r = s(
                                a.matches[0].replace(ia, si),
                                (ra.test(i[0].type) && fa(t.parentNode)) || t
                            ))
                        ) {
                            if ((i.splice(o, 1), !(e = r.length && ma(i))))
                                return Ui.apply(n, r), n;
                            break;
                        }
                }
    ...
    var ka = document,
        ...
        Oa = function (e, t, n, r) {
            ...
            if (ba(t)) t = ya(t, za(e[0]));
                ...
                if (((t = Wa.makeArray(t)), r))
                    for (o = t.length - 1; 0 <= o; o--) Oa(e, t[o], n, r);
    ...
    (wa.fn = wa.prototype =
        {
            ...
            init: function (e, t) {
                ...
                if (ba(e)) {
                    if (
                        ...
                        return Wa(t).find(e);
                    if (n[1])
                        for (r = ya(e, za(t)).firstChild; r; ) _a.call(o, r), (r = r.nextSibling);
                    else {
            ...
            add: function (e, t) {
                ...
                if (!1 !== t)
                    for (
                        n = Wa.unique(this.toArray().concat(Wa.makeArray(e))),
            ...
            remove: function () {
                for (var e, t = this.length; t--; )
                    (e = this[t]), Da.clean(e), e.parentNode && e.parentNode.removeChild(e);
                return this;
            },
            empty: function () {
                for (var e, t = this.length; t--; )
    ...
    var Wa = wa,
        ...
        Ja = function (a, u) {
                ...
                return (function (e, t, n) {
                    ...
                    if (((n = n || e), t)) {
                        if (
                            n === e &&
                            t.getBoundingClientRect &&
                            'static' === xn(Nt.fromDom(e), 'position')
                        ) {
            ...
            var _,
                ...
                M = u.schema || to({}),
                F = ro(
                    { url_converter: u.url_converter, url_converter_scope: u.url_converter_scope },
                    u.schema
                ),
        ...
        tu =
            ...
            (nu.prototype.add = function (e, t, n, r) {
                ...
                this.queue.push(e),
                    ...
                    t &&
                        (this.scriptLoadedCallbacks[e] || (this.scriptLoadedCallbacks[e] = []),
    ...
    var iu = {},
        ...
        su = function () {
            ...
            function e(e, t, n) {
                void 0 === n && (n = 'added'),
                    (Ne(f, e) && 'added' === n) || (Ne(l, e) && 'loaded' === n)
                        ? t()
                    ...
                    !1 !== su.languageLoad &&
                        e(
                            ...
                            function () {
                                ...
                                !e ||
                                    (n && -1 === (',' + (n || '') + ',').indexOf(',' + e + ',')) ||
                                    tu.ScriptLoader.add(l[t] + '/langs/' + e + '.js');
                            },
                            'loaded'
                        );
                },
    ...
    function gu(e, t) {
        ...
        mu(e)
            ...
            : ((r = t), (o = du((n = e), 'class').concat([r])), pn(n, 'class', o.join(' ')));
    }
    function pu(e, t) {
    ...
    function hu(e, t) {
        return He((n = void 0 === e ? document : e.dom))
            ? []
            : T(n.querySelectorAll(t), Nt.fromDom);
        var n;
    }
    function vu(r, e) {
        function t(e, t) {
    ...
    function Cu(e, t) {
        ...
        Kt(
            i,
            ((n = t), ((r = (o || document).createElement('div')).innerHTML = n), Dn(Nt.fromDom(r)))
        ),
            Xt(e),
            Pn(e, i);
    }
                    ...
                    (function (e) {
                        ...
                        function t(e, t) {
                            ...
                            if (t < e.data.length) {
                                ...
                                if (
                                    Pu(e.data[t - 1]) &&
                                    (n.setStart(e, t), n.setEnd(e, t + 1), !Fu(n))
                                )
                                    return r(zu(is(n), !1)), o;
                            }
                            0 < t &&
                                (n.setStart(e, t - 1), n.setEnd(e, t), Fu(n) || r(zu(is(n), !1))),
                                t < e.data.length &&
                                    (n.setStart(e, t),
                                    n.setEnd(e, t + 1),
                                    Fu(n) || r(zu(is(n), !0)));
                        ...
                        if (Yu(n))
                            if (e.isAtEnd()) {
                                ...
                                if (((a = os(n, i)), ts(a) && t(a, 0), Zu(a) && e.isAtEnd()))
                                    return r(zu(is(a), !1)), o;
                                var u = os(e.container(), e.offset() - 1);
                                Zu(u) &&
                                    !ns(u) &&
                                    ((!Ju(u) && !Ju(a) && Zu(a)) || r(zu(is(u), !1))),
                                    Zu(a) && r(zu(is(a), !0));
                            }
                        return o;
                    })(as(t, n)));
    ...
    function ps(e, t) {
        ...
        zn(o) &&
            ...
            ((i = t ? 0 : o.childNodes.length), e['set' + (t ? 'Start' : 'End')](o, i));
    }
    function hs(e) {
    ...
    function vs(e, t) {
        var n;
        return zn(e) && ((e = Bu(e, t)), dc(e))
            ? e
            : Ir(e)
            ? ((n = (e = jn(e) && Pr(e) ? e.parentNode : e).previousSibling),
              dc(n) ? n : ((n = e.nextSibling), dc(n) ? n : void 0))
            : void 0;
    }
    function bs(e, t, n) {
        var r = n.getNode(),
        ...
        return m
            ? { name: (o = m.tagName), index: gs(n.dom, o, m) }
            : ((f = (s = n).dom),
    ...
    function Cs(e, t) {
        ...
        return (
            i || (s.collapse(!1), ss(n, s, ys(n, o + '_end', t))),
            (r = hs(r)).collapse(!0),
    ...
    function Hs(e, t) {
        return as.isTextPosition(t)
            ? ((r = t),
              hc((n = e)) && r.container() === n
                  ? ((a = Ms((o = n).data.substr(0, (i = r).offset()))),
                    (u = Ms(o.data.substr(i.offset()))),
                    0 < (a.text + u.text).length ? (Fs(o), as(o, i.offset() - a.count)) : i)
                  : Us(n, r))
    ...
    function Vs(e, i, a, u) {
        function s() {
            !(function () {
                for (
                    var e = hu(Nt.fromDom(i), '*[contentEditable=false],video,audio,embed,object'),
                        t = 0;
                    t < e.length;
                    t++
                ) {
            ...
            show: function (e, t) {
                ...
                l = (function (e, t, n) {
                    ...
                    o.setAttribute('data-mce-caret', n ? 'before' : 'after'),
                        ...
                        o.appendChild(
                            ((r = document.createElement('br')).setAttribute('data-mce-bogus', '1'),
                            r)
                        );
                    var i = t.parentNode;
                    return (
                ...
                var r = js(i, t, e);
                Wa(l).css('top', r.top);
                var o = Wa('<div class="mce-visual-caret" data-mce-bogus="all"></div>')
                    .css(_e({}, r))
                    .appendTo(i)[0];
                return (
                    ...
                    (c = _r.setInterval(function () {
                        u()
                            ? Wa('div.mce-visual-caret', i).toggleClass('mce-visual-caret-hidden')
                            : Wa('div.mce-visual-caret', i).addClass('mce-visual-caret-hidden');
                    }, 500)),
    ...
    function Js(e, t) {
        ...
        return (
            e ? (n.setStartBefore(t), n.setEndBefore(t)) : (n.setStartAfter(t), n.setEndAfter(t)), n
        );
    }
    function Qs(e, t, n) {
    ...
    var ic,
        ...
        fc = function (e) {
            return e
                ? me(
                      ...
                      function (e, t) {
                          return (
                              sc(t) && 'BR' !== t.nodeName ? (e = e.concat(fc(t))) : e.push(t), e
                          );
                      },
                      []
                  )
        ...
        vc = function (e) {
            pc(e) && Ir(e) && (Mr(e) ? e.removeAttribute('data-mce-caret') : Is(e)),
                hc(e) && (Fs(e), 0 === e.data.length && Is(e));
        },
        bc = dt().browser,
        yc = Yn,
        Cc = Jn,
    ...
    function Fc(o, i, a) {
        return Gl(o, i, a).bind(function (e) {
            return Ys(a, e, i) &&
                ...
                o
                    ? !Mc(t, n) &&
                      (as.isTextPosition((r = t)) || !Wn(r.getNode())) &&
                      Ic(t) &&
                      Lc(n)
                    : !Mc(n, t) && Lc(t) && Ic(n))
                ? Gl(o, i, e)
    ...
    function Uc(e, t) {
        ...
        return jn(u)
            ? ve.some(as(u, e ? 0 : u.data.length))
            : u
            ? jr(u)
                ? ve.some(e ? as.before(u) : Wn((a = u)) ? as.before(a) : as.after(a))
                : ((r = t), (o = u), (i = (n = e) ? as.before(o) : as.after(o)), Gl(n, r, i))
            : ve.none();
    }
    function zc(e) {
        return zn(e) && e.id === nf;
                ...
                if (Ne(t, 'id'))
                    return dn(
                        ...
                        function (e, t) {
                            var n = o.createRng();
                            return (
                                n.setStart(Vc(o, e.container()), e.offset()),
    ...
    function Zc(e, t, n) {
        var r,
            ...
            i = n.startContainer;
        if (
            (i !== n.endContainer || !(r = i.childNodes[o]) || !/^(IMG)$/.test(r.nodeName)) &&
            zn(i)
        ) {
            var a = i.childNodes,
                u = void 0;
            o < a.length
                ...
                : ((i = a[a.length - 1]), (u = new Rr(i, e.getParent(i, e.isBlock))).next(!0));
            for (var s = u.current(); s; s = u.next())
                if (jn(s) && !af(s)) return n.setStart(s, 0), t.setRng(n), 0;
        }
    }
    function el(e, t, n) {
        if (e) {
    ...
    function xl(e, t, n, r, o) {
        ...
        for (;;) {
            ...
            for (var c = a[u]; c; c = c[u]) {
                ...
                if (
                    !uf(c) &&
                    (!Wn((i = c)) || !i.getAttribute('data-mce-bogus') || i.nextSibling) &&
                    !cf(c, l)
                )
                    return a;
            }
    ...
    function Sl(e, t, n, r) {
        ...
        return (
            ...
            zn(a) &&
                a.hasChildNodes() &&
                ((a = Bu(a, t.collapsed ? u : u - 1)), jn(a) && (u = a.nodeValue.length)),
            (o = gl(s, o)),
            (a = gl(s, a)),
            wl(o) &&
                ((o = uf(o) ? o : o.parentNode),
                (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
                jn(o) && (i = t.collapsed ? o.length : 0)),
            wl(a) &&
                ((a = uf(a) ? a : a.parentNode),
    ...
    function Rl(o, e) {
        return dn(
            ...
            jn(r)
                ? 0 === i
                    ? ve.some(Nt.fromDom(r))
                    : ve.none()
                : ve.from(r.childNodes[i]).map(Nt.fromDom)),
            ((t = e.endContainer),
            (n = e.endOffset),
            jn(t)
                ? n === t.data.length
                    ? ve.some(Nt.fromDom(t))
                    : ve.none()
                : ve.from(t.childNodes[n - 1]).map(Nt.fromDom)),
            function (e, t) {
                var n = M(df(o), A(je, e)),
                    r = M(mf(o), A(je, t));
            ...
            o = function (e) {
                ...
                switch (
                    ...
                    Ot(o).fold(
                        ...
                        function (e) {
                            return 'br' === a || (_n((n = o)) && Pl(n) === Co)
                                ? 'valid'
                                : kn((t = o)) && pu(t, ju())
                                ? 'existing'
                                : zc(o.dom)
                                ? 'caret'
                                : nl(r, i, a) && nl(r, kt(e), i)
                                ? 'valid'
                                : 'invalid-child';
                            var t, n;
                        }
    ...
    var zl,
        ...
        Yl = function (e, t, n) {
            ...
            if (t.isEqual(as.after(n)) && n.lastChild) {
                if (((i = as.after(n.lastChild)), e < 0 && Kl(n.lastChild) && $l(n.lastChild)))
            ...
            if (ql(c)) {
                ...
                if (e < 0 && 0 < l && ((f = Oc(c, l - 1)), Kl(f)))
                    return !Ul(f) && (o = Ks(f, e, Xl, f))
                        ? ql(o)
                            ? as(o, o.data.length)
                            : as.after(o)
                        : ql(f)
                ...
                if (0 < e && l < c.childNodes.length && ((f = Oc(c, l)), Kl(f)))
                    return Wl(f)
                        ? ((a = n),
                          (s = (u = f).nextSibling) && Kl(s)
                              ? ql(s)
                                  ? as(s, 0)
                                  : as.before(s)
                              : Yl(ic.Forwards, as.after(u), a))
                        : !Ul(f) && (o = Ks(f, e, Xl, f))
                        ? ql(o)
                            ? as(o, 0)
                            : as.before(o)
    ...
    function Cf(r, l) {
        ...
        function i(e) {
            ...
            return (
                ...
                (T.hasClass(e, 'mce-preview-object')
                    ? ze(Nt.fromDom(e.firstElementChild), t)
                    : ze(Nt.fromDom(e), t))
            );
        }
        function a(e, t, n) {
        ...
        function g(e) {
            ...
            (k = u * b[2] + w),
                ...
                (k = k < 5 ? 5 : k),
                (_ = _ < 5 ? 5 : _),
                ((c(p) || f(p)) && !1 !== l.getParam('resize_img_proportional', !0, 'boolean')
                    ? !Bf.modifierPressed(e)
                    : Bf.modifierPressed(e)) &&
                    (L(u) > L(s)
                        ? ((_ = I(k * E)), (k = I(_ / E)))
                        : ((k = I(_ / E)), (_ = I(k * E)))),
                ...
                N ||
                    ...
                    (i = S),
                    (a = 'corner-' + b.name),
                    l.fire('ObjectResizeStart', { target: r, width: o, height: i, origin: a }),
                    (N = !0));
        }
        function o(e) {
            function t(e, t) {
            ...
            U = function () {
                ...
                (N = !1),
                    ...
                    o &&
                        ...
                        (n = _),
                        (r = 'corner-' + b.name),
                        l.fire('ObjectResized', { target: e, width: t, height: n, origin: r }),
    ...
    function wf(t, n, r) {
        ...
        if (s.caretPositionFromPoint)
            (e = s.caretPositionFromPoint(t, n)) &&
                ((o = r.createRange()).setStart(e.offsetNode, e.offset), o.collapse(!0));
    ...
    function Af(e, t, n, r) {
        ...
        if (
            (zn(u) && s > u.childNodes.length - 1 && (f = !1), qn(u) && ((u = i), (s = 0)), u === i)
        ) {
        ...
        return (
            t === r && jn(t)
                ? 0 < n &&
                  ...
                  ((t = (r = Df(t, n)).previousSibling),
                  n < o
                      ? ((t = r = Df(r, (o -= n)).previousSibling),
                        (o = r.nodeValue.length),
                        (n = 0))
                      : (o = 0))
                : (jn(t) && 0 < n && n < t.nodeValue.length && ((t = Df(t, n)), (n = 0)),
                  jn(r) &&
                      0 < o &&
                      o < r.nodeValue.length &&
                      (o = (r = Df(r, o).previousSibling).nodeValue.length)),
        ...
        Mf =
            ...
            }),
            {
                set: function (e, t) {
                    if (!E(t) && !t.match(/^[0-9]+$/))
                        throw new Error(
                            Lf + '.set accepts only positive integer values. Value was ' + t
                        );
                    var n = e.dom;
    ...
    function td(e) {
        return (
            void 0 === e && (e = Nt.fromDom(document)), ve.from(e.dom.activeElement).map(Nt.fromDom)
        );
    }
    function nd(e, t) {
    ...
    function ud(e) {
        return Bd.range(
            Nt.fromDom(e.startContainer),
            e.startOffset,
            Nt.fromDom(e.endContainer),
            e.endOffset
        );
    }
    function sd(e) {
        ...
        try {
            return (
                t.setStart(e.start.dom, e.soffset), t.setEnd(e.finish.dom, e.foffset), ve.some(t)
            );
        } catch (e) {
            return ve.none();
        }
    ...
    function gd(e, t) {
        e.focusedEditor === t.editor && (e.focusedEditor = null),
            e.activeEditor || (Id.unbind(document, 'focusin', Nd), (Nd = null));
    }
    function pd(t, e) {
        var n, r;
        (n = Nt.fromDom(t.getBody())),
            ((r = e).collapsed
                ? ve.from(Bu(r.startContainer, r.startOffset)).map(Nt.fromDom)
                : ve.none()
            )
                .bind(function (e) {
    ...
    function Ed(e) {
        ...
        return (
            e.attr('name') || (e.attr('id') && !e.firstChild) || e.attr('data-mce-bookmark') || t
        );
    }
    var Nd,
        kd = function (r, e) {
            ...
            (Xd.isDomSafe = function (e, t, n) {
                ...
                return !(
                    ...
                    !(r = n).allow_html_data_urls &&
                        (/^data:image\//i.test(o)
                            ? (V((a = r.allow_svg_data_urls)) ? !a : !V(i) || !D(Wd, i)) &&
            ...
            : ((n = 0 === e.indexOf('//')),
              ...
              /^[\w\-]*:?\/\//.test(e) ||
                  ((r = this.settings.base_uri
                      ...
                      : new Xd(document.location.href).directory),
                  (e =
    ...
    function Gd(q, $) {
        ...
        function n(s, e) {
            ...
            for (
                ...
                var j = t[0];
                if ((w < t.index && R(N(x.substr(w, t.index - w))), (i = t[7])))
            ...
            for (w < x.length && R(N(x.substr(w))), r = S.length - 1; 0 <= r; r--)
                ...
                return (!Bm(d, 0) || Om(f, m)
                    ? ((s = (a = l).data),
                      (c = T((u = s.split('')), function (e, t) {
                          return of(e) && 0 < t && t < u.length - 1 && Jc(u[t - 1]) && Jc(u[t + 1])
                              ? ' '
                              : e;
                      }).join('')) !== s && ((a.data = c), 1))
                    : ((i.data = ' ' + d.slice(1)), 1)) ||
                    ...
                    (r = (n = l).data),
                    (o = as(n, r.length - 1)),
                    Bm(r, r.length - 1) && !Om(t, o) && ((n.data = r.slice(0, -1) + ' '), 1))
                    ? ve.some(e)
                    : ve.none();
            });
    }
    ...
    function zm(e, t, n, r) {
        ...
        var o = Ze(e.data).length,
            ...
            a = r ? t : e;
        return (
            r ? i.appendData(a.data) : i.insertData(0, a.data), Ln(Nt.fromDom(a)), n && Fm(i, o), i
        );
    }
    function Hm(e, t) {
        return (
            ...
            (o = (n = t).container()),
            (i = n.offset()),
            !1 === as.isTextPosition(n) && o === r.parentNode && i > as.before(r).offset()
                ? as(t.container(), t.offset() - 1)
                : t
        );
        var n, r, o, i;
    }
    function jm(e) {
        return jr(e.previousSibling)
            ? ve.some(((t = e.previousSibling), jn(t) ? as(t, t.data.length) : as.after(t)))
            : e.previousSibling
            ? tf(e.previousSibling)
            : ve.none();
        var t;
    }
    function Vm(e) {
        return jr(e.nextSibling)
            ? ve.some(((t = e.nextSibling), jn(t) ? as(t, 0) : as.before(t)))
            : e.nextSibling
            ? ef(e.nextSibling)
            : ve.none();
        var t;
                ...
                : ng(y, (i = C), (a = t), b)
                      ...
                      .bind(function (e) {
                          ...
                          if (0 < n.length) {
                              ...
                              var r = ig(a, i);
                              return ve.some(
                                  sp.partialTable(n, ve.some(_e(_e({}, i), { rng: r })))
                              );
                          }
                          return ve.none();
                      })
    ...
    function sg(e, t, n, r) {
        var o = n.cloneRange();
        r
            ? (o.setStart(n.startContainer, n.startOffset), o.setEndAfter(t.dom.lastChild))
            : (o.setStartBefore(t.dom.firstChild), o.setEnd(n.endContainer, n.endOffset)),
            lp(e, o, t, !1);
    }
    function cg(e) {
        var t = _l(e),
            ...
            r &&
                (r.isEmpty(o) ||
                    ...
                    n.getBlockElements()[i.name] &&
                        ...
                        ('br' === (a = i.firstChild).name || a.value === yo))) &&
                (s = s.prev),
    ...
    function Sg(e, t, n) {
        ...
        /^ | $/.test(t) &&
            ...
            (o = u.getRng()),
            (i = t),
            (i = Dm((a = Nt.fromDom(r.getRoot())), as.fromRangeStart(o))
                ? i.replace(/^ /, '&nbsp;')
                : i.replace(/^&nbsp;/, ' ')),
            (t = i =
                Tm(a, as.fromRangeEnd(o))
                    ? i.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;')
                    : i.replace(/&nbsp;(<br( \/)?>)?$/, ' ')));
        var c = e.parser,
            l = n.merge,
        ...
        if (m.isDefaultPrevented())
                ...
                u.isCollapsed() ||
                    (function (e) {
                        ...
                        var r,
                            ...
                            i = n;
                        null !== (r = o) &&
                        r === t.getParent(i.endContainer, mp) &&
                        Rl(Nt.fromDom(r), i)
                            ? lp(e, n, Nt.fromDom(o))
            ...
            if (!0 === n.paste && bg(e.schema, B) && Cg(s, I))
                return (g = wg(f, s, u.getRng(), B)), u.setRng(g), void e.fire('SetContent', m);
            if (
                ((function () {
            ...
            ve.from(u.getBody()).fold(J(s), function (e) {
                return Eg(s)
                    ? (function (e, t, n, r) {
                          ...
                          return (
                              (r.content = vo(Nt.fromDom(t)) ? s : Et.trim(s)),
                    ...
                    : ((t = u),
                      ...
                      0 === (r = s).length || /^\s+$/.test(r)
                          ? ((i = '<br data-mce-bogus="1">'),
                            ...
                            (r =
                                (a = Ss(t)) &&
                                t.schema.isValidChild(n.nodeName.toLowerCase(), a.toLowerCase())
                                    ? ((r = i), t.dom.createHTML(a, Es(t), r))
                                    : r || '<br data-mce-bogus="1">'),
                            Ng(t, r, o.no_selection),
                            t.fire('SetContent', o))
                          : ('raw' !== o.format &&
                                (r = nm({ validate: t.validate }, t.schema).serialize(
        ...
        if (a)
            if (b(a.length)) {
                ...
                for (var f = 0; f < a.length; f++)
                    if ('attributes' === r ? e.getAttrib(t, a[f]) : al(e, t, a[f])) return 1;
        return 1;
    }
    ...
    function Ig(e) {
        ...
        return (
            hn(t, { id: bp, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }),
                  ...
                  (p = (g = e.dom).getParent((m = null !== s ? s : i), A(tl, e))) && g.isEmpty(p)
                      ...
                      : ((h = Nt.fromDom(m)),
                        ...
                        (b = U(
                            (function () {
                                for (var e = [], t = h.dom; t; )
                                    e.push(Nt.fromDom(t)), (t = t.lastChild);
                                return e;
                            })().slice(-1),
                            Br
                        )),
        ...
        hp = function (e, t, n, r, o) {
            ...
            if (i && t)
                for (var u = 0; u < i.length; u++) {
                    ...
                    if (
                        Tg(e.dom, t, s) &&
                        Og(a, t, s, 'attributes', o, r) &&
                        Og(a, t, s, 'styles', o, r)
                    ) {
                        var c = s.classes;
                        if (c)
                            for (var l = 0; l < c.length; l++)
                                if (!e.dom.hasClass(t, rl(c[l], r))) return;
                        return s;
                    }
                }
        },
    ...
    function Ep(e, t, n) {
        ...
        if (
            t &&
            n &&
            ((t = Sp(t, 'previousSibling')), (n = Sp(n, 'nextSibling')), r.compare(t, n))
        ) {
    ...
    function Rp(e, t, n) {
        ...
        return (
            zn(o) &&
                ((r = o.childNodes.length - 1), !n && i && i--, (o = o.childNodes[r < i ? r : i])),
    ...
    function Pp(e, r, o, t, i) {
        ...
        if (
            !(
                (dl((a = r)) && kh(c, a.inline)) ||
                (ll(a) && kh(c, a.block)) ||
                (fl(a) && zn(c) && s.is(c, a.selector)) ||
        ...
        if ('all' !== r.remove) {
            Nh(r.styles, function (e, t) {
                (e = il(u, rl(e, o), t + '')),
                    E(t) && ((t = e), (i = null)),
                    (!r.remove_similar && i && !kh(al(u, i, t), e)) || u.setStyle(b, t, ''),
                    (n = !0);
            }),
                n &&
                    '' === u.getAttrib(b, 'style') &&
                ...
                Nh(r.attributes, function (e, t) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (
                                (Eh.test(t) && b.removeAttribute('data-mce-' + t),
                                'style' === t &&
                                    on(['li'])(b) &&
              ...
              ll(d) &&
                  (v
                      ...
                      : h.isBlock(f) &&
                        !h.isBlock(p) &&
                        (Bp(h, f, !1) ||
                            Bp(h, f.firstChild, !0, !0) ||
                            f.insertBefore(h.create('br'), f.firstChild),
                        Bp(h, f, !0) ||
                            Bp(h, f.lastChild, !1, !0) ||
                            f.appendChild(h.create('br')))),
              (fl((g = d)) && dl(g) && fn(ue(g, 'mixed'), !0) && !kh(d.inline, f)) ||
                  h.remove(f, !0),
              Sh.removed())
            : Sh.keep();
    }
    ...
    function Ip(u, s, c, e, l) {
            ...
            if (g.split) {
                if (((t = Tf(t)), (r = Rp(u, t, !0)) !== (o = Rp(u, t)))) {
                    if (((r = Dp(r, !0)), (o = Dp(o, !1)), Ap(h, r, o))) {
                        ...
                        return (
                            a(Op(h, n, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })),
                            void d(!0)
                        );
                    }
                    if (Ap(h, o, r))
                        return (
                            ...
                            a(Op(h, n, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })),
                            void d(!1)
                        );
        ...
        var n,
            ...
            v = function (t) {
                ...
                var r,
                    ...
                    i = xe(t.childNodes);
                if (
                    (p && !n && ((r = f(t)), (o = t.parentNode), !r && V(o) && ml(g) && f(o)),
                    g.deep && i.length)
                ) {
                ...
                Y(['underline', 'line-through', 'overline'], function (e) {
                    zn(t) &&
                        ...
                        Lp(
                            u,
                            { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: e } },
                            null,
                            t
                        );
                });
        ...
        if (e)
            return (
                Qc(e) ? ((n = h.createRng()).setStartBefore(e), n.setEndAfter(e), t(n)) : t(e),
                void yf(u, s, e, c)
            );
            ...
            Y(l.split(','), function (t) {
                ...
                var n,
                    r = ue(g, t).getOrThunk(function () {
                        var e = {
                            withSimilar: { state: ru(!1), similar: !0, callbacks: [] },
                            withoutSimilar: { state: ru(!1), similar: !1, callbacks: [] },
                            withVars: []
                        };
                        return (g[t] = e);
                    });
                b(m)
                    ...
                    : r.withVars.push({ state: ru(e()), similar: d, vars: m, callback: f });
            }),
            c.set(g),
            {
                unbind: function () {
        ...
        return (
            Y(hu(e, 'tr'), function (n, r) {
                Y(hu(n, 'td,th'), function (e, t) {
                    !(function (e, t, n, r, o) {
                        for (
                            var i = $p(o, 'rowspan'), a = $p(o, 'colspan'), u = e.rows, s = n;
                            s < n + i;
                            s++
                        ) {
                            u[s] || (u[s] = qp(Su(r), []));
            ...
            undoManager: {
                ...
                add: function (e, t, n, r, o, i) {
                    return (function (e, t, n, r, o, i, a) {
                        ...
                        if (
                            e
                                .fire('BeforeAddUndo', { level: i, lastLevel: s, originalEvent: a })
                                .isDefaultPrevented()
                        )
                            return null;
                ...
                undo: function (e, t, n) {
                    return (
                        ...
                        (i = t),
                        (a = n),
                        (o = e).typing && (o.add(), (o.typing = !1), lh(o, !1, i)),
                        0 < a.get() &&
                            (a.set(a.get() - 1),
            ...
            formatter: {
                ...
                canApply: function (u) {
                    return (function (e) {
                        ...
                        if (t)
                            for (
                                var r = sl(n, e.selection.getStart()), o = t.length - 1;
                                0 <= o;
                                o--
                            ) {
                                var i = t[o];
            ...
            editor: {
                getContent: function (e, t) {
                    return (
                        ...
                        ve
                            .from(d.getBody())
                            .fold(J('tree' === m.format ? new Ud('body', 11) : ''), function (e) {
                                return (
                                    (t = d),
                                    (r = e),
                                    (o = g),
                                    ...
                                    (f =
                                        'raw' === l.format
                                            ...
                                            : ((a = (i = t).serializer.serialize(r, l)),
                                              ...
                                              a.replace(s, ''))),
                                    D(['text', 'tree'], l.format) || vo(Nt.fromDom(r))
                                        ? (l.content = f)
                                        : (l.content = Et.trim(f)),
            ...
            return t
                ...
                .map(function (e) {
                    ...
                    Ot((n = e)).each(function (e) {
                        ...
                        r && Dm(e, as(t, 0))
                            ? Fm(t, 0)
                            : !r && Tm(e, as(t, t.length)) && Um(t, t.length);
                    });
                });
        });
    }
        ...
        Rh = function (S, E, N, r) {
            function k(n, e) {
                ...
                y((e = void 0 === e ? A : e).onformat) && e.onformat(n, e, N, r),
                    ...
                    !e.styles ||
                        ((t = u.getAttrib(n, 'style')) && u.setAttrib(n, 'data-mce-style', t)),
            ...
            function g(e, t) {
                ...
                return (
                    Ah(e, function (e) {
                        return (
                            !!fl(e) &&
                            ((V(e.collapsed) && e.collapsed !== a) || !u.is(t, e.selector) || zc(t)
                                ? void 0
                                : (k(t, e), !(n = !0)))
                        );
                    }),
                                ...
                                Wn(e) &&
                                    !(function (e, t, n, r) {
                                        if (
                                            ...
                                            return (
                                                se(o, r) && Wr(Nt.fromDom(n.parentNode), !1) && !i
                                            );
                                        }
                                        var a, u, s, c;
                                    })(S, A, e, i))
                            ...
                            ? (dl(A) || (ll(A) && A.wrapper)) &&
                              ...
                              (i = A).styles &&
                                  ...
                                  wh(
                                      a,
                                      kp(x, 'fontSize'),
                                      _p(x, 'backgroundColor', rl(i.styles.backgroundColor, N))
                                  ),
                              (m = x),
                              (p = e),
                              (g = A).styles &&
                              ...
                              !dl((r = A)) ||
                                  ...
                                  (wh(o, kp(t, 'fontSize'), _p(t, 'fontSize', '')),
    ...
    function Lh(a, u, e, s) {
        ...
        var l,
            ...
            p = function () {
                ...
                return (
                    (n = n || (o.createRange ? o.createRange() : o.body.createTextRange()))
                        .setStart &&
            ...
            h = function (e, t) {
                ...
                if ((r = e) && (Bh(r) || (Ph(r.startContainer) && Ph(r.endContainer)))) {
                    ...
                    if (o) {
                        ...
                        var i = c();
                        if (
                            ((e = s.fire('SetSelectionRange', { range: e, forward: t }).range), i)
                        ) {
                            f = e;
                            try {
            ...
            v = {
                ...
                getNode: function () {
                    return (function (e, t) {
                        ...
                        return !t.collapsed &&
                            ...
                            3 === n.nodeType &&
                                3 === r.nodeType &&
                                ((n = n.length === o ? xd(n.nextSibling, !0) : n.parentNode),
                ...
                getSelectedBlocks: function (e, t) {
                    return (function (e, t, n, r) {
                        var o = [],
                            i = e.getRoot();
                        if (
                            ((n = e.getParent(n || yd(i, t, t.collapsed), e.isBlock)),
                ...
                getBoundingClientRect: function () {
                    var e = p();
                    return e.collapsed
                        ? as.fromRangeStart(e).getClientRects()[0]
    ...
    function jh(e, t, n, r) {
        (e.padd_empty_with_br || t.insert) && n[r.name]
            ? (r.empty().append(new Ud('br', 1)).shortEnded = !0)
            : (r.empty().append(new Ud('#text', 3)).value = yo);
    }
    function Vh(n, e, t, r) {
                    ...
                    if (((i = (o = e[r]).parent), d[o.parent.name] && o === i.lastChild)) {
                        ...
                        o &&
                            ...
                            Vh(h, m, g, i) &&
                                ...
                                (c.removeEmpty ? i.remove() : c.paddEmpty && jh(p, n, d, i)));
                    } else {
                        for (
                            a = o;
                        ...
                        a === i &&
                            ...
                            (((l = new Ud('#text', 3)).value = yo), o.replace(l));
                    }
            }),
                    ...
                    for (var t, n, r, o = e.length; o--; )
                        ('ul' !== (r = (n = e[o]).parent).name && 'ol' !== r.name) ||
                            (n.prev && 'li' === n.prev.name
                                ? n.prev.append(n)
                                : ((t = new Ud('li', 1)).attr('style', 'list-style-type: none'),
                                  n.wrap(t)));
                }),
            p.validate &&
                h.getValidClasses() &&
    ...
    function $h(_, A) {
        ...
        var e = {
            ...
            parse: function (e, u) {
                ...
                var m = pv(
                        dv('script,style,head,html,body,title,meta,param'),
                        A.getBlockElements()
                    ),
                    ...
                    N = Gd(
                        {
                            ...
                            start: function (e, t, n) {
                                ...
                                if (a) {
                                    ...
                                    if ((E && y[e] && (E = !1), a.removeEmpty && Vh(A, g, y, c)))
                                        return (
                                            (o = c.parent),
                                    ...
                                    a.paddEmpty &&
                                        ((fv((i = c), '#text') && i.firstChild.value === yo) ||
                                            Vh(A, g, y, c)) &&
                                        jh(_, u, m, c),
                                        (c = c.parent);
                                }
        ...
        return (
            ...
            t.addNodeFilter('script,style', function (e, t) {
                for (
                    ...
                    'script' === t
                        ? ((o = i.attr('type')) &&
                              i.attr('type', 'mce-no/type' === o ? null : o.replace(/^mce\-/, '')),
            ...
            t.addAttributeFilter('data-mce-type', function (e) {
                Y(e, function (e) {
                    'format-caret' === e.attr('data-mce-type') &&
                        (e.isEmpty(t.schema.getNonEmptyElements()) ? e.remove() : e.unwrap());
                });
            }),
                ...
                serialize: function (e, t) {
                    var n,
                        ...
                        B =
                            ...
                            (c = i.parse(a, s)),
                            !P((f = c.lastChild)) || (P((l = f.prev)) && (f.remove(), l.remove())),
                            c);
                    function P(e) {
                        return e && 'br' === e.name;
                    }
        ...
        var o,
            ...
            h =
                ((i =
                    ...
                    (c = p),
                    (a = e) &&
                    (0, (f = (l = u).sections()), Zh(l, 'mobile') && 'mobile' === f.mobile.theme)
                        ? U(c, A(D, Nv))
                        : a && Zh(u, 'mobile')
                        ? c
                        : s)),
                [].concat(Qh(d)).concat(Qh(i)));
    ...
    function zv(e) {
        ...
        e.contentCSS = e.contentCSS.concat(
            cy(
                ...
                X(n) ? T(n.split(','), Je) : S(n) ? n : !1 === n || t.inline ? [] : ['default'])
            ),
            cy(e, Ds(e))
        );
    }
        ...
        function o(e, t, n) {
            return (
                (e = r(
                    e,
                    'src="' + t + '"',
                    'src="' + n + '"' + (n === xt.transparentSrc ? ' data-mce-placeholder="1"' : '')
                )),
    ...
    function Xv(e, t) {
        function m(e) {
            ...
            var t,
                ...
                r = n;
            return (
                (t = o).classes.length && dy.addClass(r, t.classes.join(' ')),
                ...
                if (
                    !(
                        ('background-color' === e &&
                            ...
                            ((t = dy.getStyle(n.getBody(), e, !0)),
                            '#ffffff' === dy.toHex(t).toLowerCase())) ||
        ...
        return (
            ...
            (i = c).on('mouseup keydown', function (e) {
                ...
                Fg(t, null, !1),
                    (8 !== n && 46 !== n) ||
                        !r.isCollapsed() ||
                        r.getStart().innerHTML !== vp ||
                        Fg(t, Hc(o, r.getStart())),
            ...
            }),
            {
                ...
                matchNode: function (e, t, n, r) {
                    return (
                        (o = e), (i = t), (a = n), (u = r), hh(c).formatter.matchNode(o, i, a, u)
                    );
                    var o, i, a, u;
                },
                canApply: function (e) {
        ...
        return (
            mh(s) ||
                ...
                n.on('keyup', function (e) {
                    var t = e.keyCode;
                    e.isDefaultPrevented() ||
                        (((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t || e.ctrlKey) &&
                            (a(), n.nodeChanged()),
                        ...
                        ((33 <= n && n <= 36) || (37 <= n && n <= 40) || 45 === n
                            ...
                            : ((t = (e.ctrlKey && !e.altKey) || e.metaKey),
                              !(n < 16 || 20 < n) ||
                                  ...
                                  r.typing ||
                                  t ||
                                  (r.beforeChange(), lh(r, !0, o), r.add({}, e), i.set(!0))));
                }),
    ...
    function nb(e, t) {
        return ze(
            Nt.fromDom(t),
            e.getParam('inline_boundaries_selector', 'a[href],code,.mce-annotation', 'string')
        );
    }
    function rb(e, t, n) {
        var r,
    ...
    function pb(e, t, n) {
        return (
            gb(!0, t),
            gb(!1, n),
            (Ve((o = n), (r = t)) ? ((i = hm(r, o)), ve.from(i[i.length - 1])) : ve.none()).fold(
                A(mb, e, t, n),
                A(db, e, t, n)
            )
        );
        ...
        return (
            ...
            !bb((u = i), (s = a).startContainer) && !bb(u, s.endContainer) && c && l
                ...
                : ((n = f),
                  ...
                  (o = r.getRng()),
                  dn(
                      ab(n, Nt.fromDom(o.startContainer)),
                      ab(n, Nt.fromDom(o.endContainer)),
                      function (e, t) {
                          return (
                              !1 === je(e, t) &&
                              (o.deleteContents(),
                    ...
                    (!1 === c && tp(f)
                        ...
                        : ((r = s),
                          ...
                          zn(a) && a.getAttribute('data-mce-caret') === u
                              ? ((n = o.getNode(!1 === (t = e))),
                                (t && Yn(n.nextSibling)
                                    ? ve.some(Cy.moveToElement(n.nextSibling))
                                    : !1 === t && Yn(n.previousSibling)
                                    ? ve.some(Cy.moveToElement(n.previousSibling))
                                    : ve.none()
                                ).fold(function () {
                                    return Rb(r, e, o);
                                }, ve.some))
    ...
    function Ob(e, t) {
        ...
        return (
            ...
            Db(e, n.parentNode)
                ...
                .fold(function () {
                    return (
                        Y(hu(Nt.fromDom(e.getBody()), '.mce-offscreen-selection'), Ln),
            ...
            e
                ? function (e) {
                      if (xy(e.previousSibling))
                          return (
                              Mb(e.previousSibling) || e.previousSibling.appendData(Co),
                              e.previousSibling
                          );
                ...
                : function (e) {
                      if (xy(e.nextSibling))
                          return (
                              Ib(e.nextSibling) || e.nextSibling.insertData(0, Co), e.nextSibling
                          );
    ...
    function Jb(e) {
        return (
            !1 ===
            ((t = Ny(e)),
            'rtl' === Ja.DOM.getStyle(t, 'direction', !0) || ((n = t.textContent), py.test(n)))
        );
        var t, n;
    }
    function Qb(e, t, n) {
    ...
    function ny(a, e, u, t, n, s) {
        return dn(rb(e, u, t), rb(e, u, n), function (e, t) {
            return e !== t && ((r = t), (o = Xs(e, (n = u))), (i = Xs(r, n)), o && o === i)
                ? Ey.after(a ? e : t)
                : s;
            var n, r, o, i;
        }).getOr(s);
    ...
    function oy(e, t) {
        return e
            ? t.fold(i(ve.some, Ey.start), ve.none, i(ve.some, Ey.after), ve.none)
            : t.fold(ve.none, i(ve.some, Ey.before), ve.none, i(ve.some, Ey.end));
    }
    function iy(e, a, u, s) {
        var t = ob(e, s),
            c = Qb(a, u, t);
    ...
    function ky(e, t, n) {
        var r = e ? 1 : -1;
        return (
            t.setRng(as(n.container(), n.offset() + r).toRange()),
        ...
        for (var o, i, a, u, s = Pc(n), c = r, l = []; c; ) {
            ...
            if (Wn(f.getNode(!1)))
                return t === ic.Forwards
                    ? { positions: _y(t, l).concat([f]), breakType: uy.Br, breakAt: ve.some(f) }
                    : { positions: _y(t, l), breakType: uy.Br, breakAt: ve.some(f) };
            if (f.isVisible()) {
                if (e(c, f)) {
                    var d =
                        ((o = c),
                        Wn((i = f).getNode(t === ic.Forwards))
                            ? uy.Br
                            : !1 === Ys(o, i)
                            ? uy.Block
                            : uy.Wrap);
        ...
        if ((c = r(a) ? a.getNode() : o(a) ? a.getNode(!0) : Ou(n))) {
            var p = (function (e, t, n, r) {
                    ...
                    var i,
                        ...
                        f =
                            1 === e
                                ? ((i = s.next), (a = Du), (u = Ru), as.after(r))
                                : ((i = s.prev), (a = Ru), (u = Du), as.before(r)),
                        d = o(f);
                    do {
                        if (f.isVisible()) {
                            var m = o(f);
    ...
    function i0(e, t, n) {
        return (
            ...
            (a = r ? as.fromRangeEnd(i) : as.fromRangeStart(i)),
            !!y(o.selection.getSel().modify) &&
                (r && Fr(a) ? ky(!0, o.selection, a) : !(r || !Ur(a)) && ky(!1, o.selection, a)))
        );
        var r, o, i, a;
    }
    function a0(g) {
            ...
            g.on('NodeChange', function (e) {
                ...
                !Ps(g) ||
                    ...
                    (l = g).selection.isCollapsed() &&
                        !0 !== l.composing &&
                        f.get() &&
                        ((d = as.fromRangeStart(l.selection.getRng())),
                        as.isTextPosition(d) &&
                            !1 === (Fr((m = d)) || Ur(m)) &&
                            (t0(l, Hs(f.get(), d)), f.set(null))),
                    (n = h),
                    (r = g),
                    (o = p),
                    (t = e.parents),
        ...
        if (e.selection.isCollapsed() && Ps(e)) {
            ...
            return (
                ...
                (f = Qb(l, c, u))
                    .bind(function (e) {
                        return a
                            ? e.fold(J(ve.some(ty(e))), ve.none, J(ve.some(ey(e))), ve.none)
                            : e.fold(ve.none, J(ve.some(ey(e))), ve.none, J(ve.some(ty(e))));
                    })
                    .map(s0(i, o))
                    .getOrThunk(function () {
                        var t = Fc(a, c, u),
        ...
        e.queryCommandState('InsertUnorderedList') ||
            ...
            Y(jC(e), function (e) {
                var t,
                    ...
                    u = v0(d, Nt.fromDom(a));
                'outdent' === r
                    ? ((t = Math.max(0, h0(a.style[u]) - o)), n.setStyle(a, u, t ? t + i : ''))
                    : ((t = h0(a.style[u]) + o + i), n.setStyle(a, u, t));
            });
    }
    function x0(e, t) {
                        ...
                        jn((h = s)) || (zn(h) && !E0(p, h) && !Yc(h))
                            ? (function (e, t) {
                                  if (jn(t)) {
                                      ...
                                      if (
                                          /^\s+$/.test(t.nodeValue) &&
                                          (!t.nextSibling || E0(e, t.nextSibling))
                                      )
                                          return 1;
                                  }
                              })(u, s)
    ...
    function k0(e, t) {
        t.hasAttribute('data-mce-caret') &&
            (zr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t));
    }
    function _0(e, t) {
        ...
        if (n)
            return 'compositionstart' === t.type
                ? (t.preventDefault(), t.stopPropagation(), void k0(e, n))
                : void (Mr(n) && (k0(e, n), e.undoManager.add()));
    }
    function A0(e, t, n) {
        var r,
            o,
        ...
        return pr(Nt.fromDom(e.container()), lo, t)
            ...
            .exists(function () {
                if (
                    ...
                    (m = y),
                    v
                        ? ((p = d.dom), My(p, m).breakAt.isNone())
                        : ((g = d.dom), Iy(g, m).breakAt.isNone()))
                ) {
                    var e =
                        ((t = b),
                        (r = x),
                        (o = v),
                        '' === (n = C)
                            ? ((l = o), P0(t, (f = Nt.fromTag('br')), l), B0(f))
                            : ((i = t),
                              (a = o),
                              (u = r),
                              (s = Nt.fromTag(n)),
    ...
    function V0(e, t, n) {
        var r,
            o,
            i = e(t, n);
        return (i.breakType === uy.Wrap && 0 === i.positions.length) ||
            (!Wn(n.getNode()) && i.breakType === uy.Br && 1 === i.positions.length)
            ? ((r = e),
              (o = t),
    ...
    function iC(e, t, n) {
        return !1 === jn(t)
            ? n
            : e
            ? 1 === n && t.data.charAt(n - 1) === Co
                ? 0
                : n
            : n === t.data.length - 1 && t.data.charAt(n) === Co
            ? t.data.length
            : n;
    }
    function aC(e, t) {
    ...
    function sC(a, e) {
        ...
        function n(e) {
            ...
            if (!jn(m) || !(e ? 0 < r : r < m.nodeValue.length)) {
                ...
                var o = new Rr(m, b);
                for (
                    jn(m) && (e && 0 === r ? o.prev() : e || r !== m.nodeValue.length || o.next());
                    (t = o.current());
        ...
        function r() {
            (u = /^(H[1-6]|PRE|FIGURE)$/.test(C) && 'HGROUP' !== x ? t(p) : t()),
                a.getParam('end_container_on_empty_block', !1) && oC(c, y) && c.isEmpty(b)
                    ? (u = c.split(y, b))
                    : c.insertAfter(u, b),
                G0(a, u);
        }
        ...
        F &&
                ...
                (m = (function (e, t, n, r) {
                    ...
                    if (!m || !oC(f, m)) {
                        ...
                        if (i && e.schema.isValidChild(s, l.toLowerCase())) {
                            for (
                                uC(e, (o = f.create(l))), i.parentNode.insertBefore(o, i), a = i;
                                a && !f.isBlock(a);
            ...
            /^(LI|DT|DD)$/.test(C) && c.isEmpty(b)
                ? ((N = t),
                  ...
                  k !== E.getBody() &&
                      ((D = (A = Z0((R = k)) && Z0(R.parentNode) ? 'LI' : A)
                          ? N(A)
                          : I.create('BR')),
                      tC(k, _, !0) && tC(k, _, !1)
                          ? Q0(k, 'LI')
                          ...
                          : (tC(k, _, !0)
                                ...
                                : ((k = eC(k)),
                                  ...
                                  'LI' === A && B.firstChild && 'LI' === B.firstChild.nodeName
                                      ? ((D = B.firstChild), I.insertAfter(B, k))
                                      : (I.insertAfter(B, k), I.insertAfter(D, k))),
                            I.remove(_)),
                      G0(E, D)))
                : (p && b === a.getBody()) ||
                  ((p = p || 'P'),
                  Pr(b)
                      ...
                      : ((S = (w = d).cloneRange()).setStart(
                            w.startContainer,
                            iC(!0, w.startContainer, w.startOffset)
                        ),
                        ...
                        (function (e, t) {
                            ...
                            if (o) {
                                ...
                                for (n = i.length; n--; )
                                    !(o = i[n]).hasChildNodes() ||
                                    (o.firstChild === o.lastChild && '' === o.firstChild.nodeValue)
                                        ? e.remove(o)
                                        : (r = o) &&
                                          'A' === r.nodeName &&
                                          e.isEmpty(r) &&
    ...
    function cC(e, t, n) {
        ...
        n ? (r.setStartBefore(t), r.setEndBefore(t)) : (r.setStartAfter(t), r.setEndAfter(t)),
    ...
    function a1(e) {
        ...
        function n(u) {
            i.on(function (e) {
                ...
                e.dragging &&
                    ((o =
                        3 === (a = (r = s).selection.getSel().getRangeAt(0).startContainer).nodeType
                            ? a.parentNode
                            : a) === (i = e.element) ||
                        r.dom.isChildOf(o, i) ||
                        D1(o) ||
    ...
    function u1(e) {
        ...
        function a(e) {
            ...
            e.isDefaultPrevented() ||
                ((t = e.dataTransfer) &&
                    (D(t.types, 'Files') || 0 < t.files.length) &&
                    (e.preventDefault(),
        ...
        a1(e),
            (n = e).on('drop', function (e) {
                var t =
                    void 0 !== e.clientX ? n.getDoc().elementFromPoint(e.clientX, e.clientY) : null;
    ...
    function c1(l) {
        ...
        function m(e, t, n, r) {
            return (
                void 0 === r && (r = !0),
                l.fire('ShowCaret', { target: t, direction: e, before: n }).isDefaultPrevented()
                    ? null
                        ...
                        var r = (function (e, t, n) {
                                ...
                                t === n && xt.ie
                                    ? (o
                                      ...
                                      i.setEndAfter(t))
                                    : (o.empty().append(yo).append(t).append(yo),
            ...
            xt.ceFalse &&
                    ...
                    (s !== x && 'HTML' !== s.nodeName && !y.isChildOf(s, x)) ||
                        ...
                        ((t = s1(l, s))
                            ? P1(t)
                                ...
                                : (h(),
                                  (B1(t) && e.shiftKey) ||
                                      hf(e.clientX, e.clientY, b.getRng()) ||
                ...
                l.on('SetSelectionRange', function (e) {
                    ...
                    e.range =
                        ...
                        (a = t.endContainer),
                        (u = t.endOffset),
                        Ne(n, o.nodeName.toLowerCase())
                            ? 0 === i
                                ? r.setStartBefore(o)
                                : r.setStartAfter(o)
                            : r.setStart(o, i),
                        Ne(n, a.nodeName.toLowerCase())
                            ? 0 === u
                                ? r.setEndBefore(a)
                                : r.setEndAfter(a)
                            : r.setEnd(a, u),
                ...
                (e = lu(function () {
                    ...
                    n.removed ||
                        ...
                        ((e = n.selection.getRng()).collapsed &&
                            ((t = Eb(n, e, !1)), n.selection.setRng(t)));
                }, 0)),
    ...
    function l1(a) {
        ...
        function A() {
            return (
                !y.isCollapsed() &&
                b.getParent(y.getStart(), b.isBlock) !== b.getParent(y.getEnd(), b.isBlock)
            );
        }
        function R(e) {
            var t = b.create('body'),
    ...
    function h1(e) {
        var t;
        !0 !== e.removed &&
            (mh((t = e)) || t.load({ initial: !0, format: 'html' }),
    ...
    function v1(t, e) {
        ...
        n.inline || (t.getElement().style.visibility = t.orgVisibility),
            ...
            t.inline &&
                (L1.addClass(r, 'mce-content-body'),
        ...
        (h.disabled = !0),
            ...
            t.readonly ||
                (t.inline &&
                    'static' === L1.getStyle(h, 'position', !0) &&
            ...
            (t.parser =
                ((i = $h(d1((u = t)), u.schema)).addAttributeFilter(
                ...
                i.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', function (e) {
                    for (var t = e.length, n = u.schema.getNonEmptyElements(); t--; ) {
                        ...
                        r.isEmpty(n) &&
                            ...
                            (r.append(new Ud('br', 1)).shortEnded = !0);
                    }
                }),
                i)),
            (t.serializer = Xh(
            ...
            (S = function (e, t) {
                ...
                !(function (e) {
                    if (eb(e)) {
                        ...
                        return (
                            !tb(e) &&
                            (Bf.metaKeyPressed(e) || e.altKey || (112 <= t && t <= 123) || D(my, t))
                        );
                    }
                })(e) &&
                    ((n = y.getBody()),
        ...
        (function (t) {
            ...
            t.fire('PreInit'),
                e.browser_spellcheck ||
                    e.gecko_spellcheck ||
                    ((n.body.spellcheck = !1), L1.setAttrib(r, 'spellcheck', 'false')),
                (t.quirks = l1(t)),
                t.fire('PostRender');
                    ...
                    t.setProgressState(!0),
                        p1(t).then(function () {
                            e().then(
                                ...
                                function (e) {
                                    t.notificationManager.open({ type: 'error', text: String(e) }),
                                        h1(t);
                                }
                            );
                        });
    ...
    function x1(e) {
        ...
        return (
            ...
            X(Bs(e))
                ...
                : y(Bs(e))
                ? ((n = (t = e).getElement()),
                  (r = Bs(t)(t, n)).editorContainer.nodeType &&
                      (r.editorContainer.id = r.editorContainer.id || t.id + '_parent'),
                  r.iframeContainer &&
                      r.iframeContainer.nodeType &&
                      (r.iframeContainer.id = r.iframeContainer.id || t.id + '_iframecontainer'),
                  (r.height = r.iframeHeight || n.offsetHeight),
                  r)
                : ((u = (o = e).getElement()),
                  o.inline
                      ? C1(null)
                      : ((i = u), (a = M1.create('div')), M1.insertAfter(a, i), C1(a)))
        );
    }
    function w1(e) {
        var n, t, r, o, i, a, u, s;
        e.fire('ScriptsLoaded'),
            ...
            (a = Bs((o = e))),
            X(a)
                ? ((o.settings.theme = y1(a)),
                  (i = Bv.get(a)),
                  (o.theme = new i(o, Bv.urls[a])),
                  o.theme.init &&
                      o.theme.init(o, Bv.urls[a] || o.documentBaseUrl.replace(/\/$/, ''), o.$))
                : (o.theme = {}),
            (s = []),
        ...
        return (
            ...
            e.inline
                ...
                : ((p = b1((m = e), (g = h))),
                  g.editorContainer &&
                      ((I1.get(g.editorContainer).style.display = m.orgDisplay),
                        ...
                        function (e) {
                            t.add(e.url, te, void 0, function () {
                                Mv(
                                    n,
                                    'IconsLoadError',
                                    Fv('icons', e.url, e.name.getOrUndefined())
                                );
                            });
                        }
                    ),
        ...
        X(i)
            ? (S1(i) ||
                  ...
                  ((t = e.getParam('theme_url'))
                      ? Bv.load(i, e.documentBaseURI.toAbsolute(t))
                      : Bv.load(i, 'themes/' + i + '/theme' + r + '.js')),
            ...
            ((K1.prototype.execCommand = function (t, n, r, e) {
                ...
                if (!u.editor.removed) {
                    ...
                    if (
                        ...
                        return u.editor.fire('ExecCommand', { command: t, ui: n, value: r }), !0;
                    try {
                        a = u.editor.getDoc().execCommand(t, n, r);
                    } catch (e) {}
                    return (
                        !!a && (u.editor.fire('ExecCommand', { command: t, ui: n, value: r }), !0)
                    );
                }
            }),
                            ...
                            (r = u).removed ||
                                (o
                                    ...
                                    : function (t) {
                                          ...
                                          t.inline || (xt.opera || hd(n), t.getWin().focus()),
                                              (xt.gecko || t.inline) && (hd(n), pd(t, r)),
                                              Md(t);
                                      })(r);
                    },
            ...
            (rx.prototype.fire = function (e, t) {
                ...
                if (o)
                    for (var i = 0, a = o.length; i < a; i++) {
                        var u = o[i];
                        if (!u.removed) {
                            if ((u.once && this.off(n, u.func), r.isImmediatePropagationStopped()))
                                return r;
                ...
                'focus' !== e &&
                    ...
                    (n.removed ||
                        (t
                            ...
                            : n.initialized &&
                              (n.dom.unbind(ix(n, e), e, n.delegates[e]), delete n.delegates[e])));
            },
    ...
    var xx = Ja.DOM,
        ...
        kx =
                        ...
                        ? t.getElement() &&
                          ...
                          (i = t.getElement().form || U1.getParent(e, 'form')) &&
                              ...
                              t.getParam('hidden_input') &&
                                  !Hn(t.getElement()) &&
                                  (U1.insertAfter(
                                      U1.create('input', { type: 'hidden', name: e }),
                                      e
                                  ),
                                  (t.hasHiddenInput = !0)),
            ...
            (_x.prototype.show = function () {
                this.hidden &&
                    ...
                    this.inline
                        ...
                        : (xx.show(this.getContainer()), xx.hide(this.id)),
                    this.load(),
                    this.fire('show'));
            }),
            (_x.prototype.hide = function () {
                ...
                e.hidden ||
                    ...
                    e.inline
                        ...
                        : (xx.hide(e.getContainer()), xx.setStyle(e.id, 'display', e.orgDisplay)),
                    (e.hidden = !0),
                    e.fire('hide'));
            }),
            ...
            (_x.prototype.resetContent = function (e) {
                void 0 === e ? Yh(this, this.startContent, { format: 'raw' }) : Yh(this, e),
            ...
            (_x.prototype.getContainer = function () {
                return (
                    this.container ||
                        (this.container = xx.get(this.editorContainer || this.id + '_parent')),
                    this.container
                );
            }),
            ...
            (_x.prototype.getWin = function () {
                ...
                return (
                    this.contentWindow ||
                        ((e = this.iframeElement) && (this.contentWindow = e.contentWindow)),
                    this.contentWindow
                );
            }),
    ...
    function _x(e, t, n) {
        ...
        (this.plugins = {}),
            ...
            this.settings.referrer_policy &&
                (tu.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
    ...
    function Rx(e) {
        e !== Mx &&
            (e ? Wa(window).on('resize scroll', Ax) : Wa(window).off('resize scroll', Ax),
            (Mx = e));
    }
    function Dx(t) {
        var e = Ux;
        ...
        Hx = _e(_e({}, fx), {
            ...
            setup: function () {
                ...
                if (r) (e = r.base || r.baseURL), (t = r.suffix);
                    ...
                    !e &&
                        ...
                        (-1 !== (o = document.currentScript.src).indexOf('.min') && (t = '.min'),
                        (e = o.substring(0, o.lastIndexOf('/'))));
                }
            ...
            add: function (e) {
                ...
                return (
                    Fx[e.id] === e ||
                        (null === n.get(e.id) &&
                            ('length' !== e.id && (Fx[e.id] = e), Fx.push(e), Ux.push(e)),
                        Rx(!0),
                        (n.activeEditor = e),
    ...
    Vx.extend = Kx = function (n) {
        function r() {
            var e, t, n;
            if (!Xx && (this.init && this.init.apply(this, arguments), (t = this.Mixins)))
        ...
        dw =
            ...
            (mw.prototype.send = function (e) {
                ...
                (o.success = function (e, t) {
                    (e = void 0 === (e = sw.parse(e)) ? { error: 'JSON Parse error.' } : e).error
