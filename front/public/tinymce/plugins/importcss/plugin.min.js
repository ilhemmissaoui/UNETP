        ...
        v.on('init', function () {
            ...
            var e,
                ...
                s =
                    ...
                    x.map(t, function (t) {
                        return x.extend({}, t, { original: t, selectors: {}, filter: u(t.filter) });
                    }));
            x.each(
                (function (c, t, s) {
                    var a = [],
                        ...
                        u = function (t, e) {
                            var r,
                                ...
                                i = p.cacheSuffix;
                            if (
                                (n = o = l(o) ? o.replace('?' + i, '').replace('&' + i, '') : o) &&
                                s(n, e) &&
                                !(function (t, e) {
                                    var r,
            ...
            var a = i.toFormats();
            v.fire('addStyleModifications', { items: a, replace: !v.getParam('importcss_append') });
        });
    }
