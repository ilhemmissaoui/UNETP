...
!(function () {
    ...
    function p(e, t, n) {
        ...
        return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
            '%D',
            '%m/%d/%Y'
        )).replace('%r', '%I:%M:%S %p')).replace('%Y', '' + n.getFullYear())).replace(
            '%y',
            '' + n.getYear()
        )).replace('%m', f(n.getMonth() + 1, 2))).replace('%d', f(n.getDate(), 2))).replace(
            '%H',
            '' + f(n.getHours(), 2)
    ...
    function y(t, e, n) {
        ...
        c && 0 < c.length && (o = r.create('div', null)).appendChild(c[0].cloneNode(!0)),
            O.each(r.select('*', o), function (e) {
                g(e, t.getParam('template_cdate_classes', 'cdate').replace(/\s+/g, '|')) &&
                    (e.innerHTML = p(
                        t,
            ...
            var T = (function (e) {
                ...
                c = function (e, t, n) {
                    var r,
                        ...
                        v = [
                            { type: 'selectbox', name: 'template', label: 'Templates', items: T },
                            {
                                type: 'htmlpanel',
                                html:
                                    '<p aria-live="polite">' +
                            ...
                            { label: 'Preview', type: 'iframe', name: 'preview', sandboxed: !1 }
                        ],
