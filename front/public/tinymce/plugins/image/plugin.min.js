    ...
    function ae(r, e) {
        var t = (function (e) {
            ...
            if (
                ...
                return (
                    n.appendChild(t),
                    n.appendChild(Ue.create('figcaption', { contentEditable: 'true' }, 'Caption')),
            ...
            A = {
                onSubmit: function (n) {
                    return function (e) {
                        ...
                        c.execCommand('mceUpdateImage', !1, me(t, n.hasAccessibilityOptions)),
        ...
        return {
            open: function () {
                ...
                (r = v),
                    ...
                    (y = L.some(r.getParam('image_prepend_url', '', 'string')).filter(function (e) {
        ...
        Ie = function (e, t, n) {
            n
                ...
                : (i === t ? ve(e).dom.removeAttribute('alt') : I(ve(e), 'alt', t),
                  'presentation' === Ue.getAttrib(e, 'role') && Ue.setAttrib(e, 'role', ''));
        },
        Ce = function (e, t, n) {
            var r = Y(e, n);
