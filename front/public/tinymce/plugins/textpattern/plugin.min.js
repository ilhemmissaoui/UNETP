...
!(function () {
        ...
        if (void 0 === o.end)
            return void 0 !== o.replacement
                ...
                : t(
                      ...
                      function (t, n) {
                          return { type: 'block-command', start: o.start, cmd: t, value: n };
                      }
                  );
    ...
    function M(t) {
        return 'block-command' === t.type
            ...
            ? { start: t.start, end: t.end, format: 1 === t.format.length ? t.format[0] : t.format }
            : void 0;
    }
    function A(t) {
        return {
    ...
    function _(t, n, r, e) {
        ...
        n.deleteContents(),
            e &&
                ...
                j(n.endContainer) && 0 === n.endContainer.data.length && t.remove(n.endContainer),
                pt(t, o, r),
                o !== a && pt(t, a, r));
    }
    function U(t, n) {
    ...
    function nt(p, t) {
        ...
        0 !== t.length &&
            ...
            (r = t),
            (e = new Date().getTime()),
            (a = 'mce_textpattern_' + Math.floor(1e9 * Math.random()) + ++bt + String(e)),
            (i = b(
                r,
                function (t, n) {
            ...
            return q(m, g, h.getRoot()).bind(function (t) {
                ...
                for (var r, e = n.toString(), o = 0; o < d.length; o++) {
                    ...
                    if (
                        ...
                        '' === (i = f) || (r.length >= i.length && r.substr(a, a + i.length) === i))
                    ) {
                        var c = d.slice();
                        c.splice(o, 1);
