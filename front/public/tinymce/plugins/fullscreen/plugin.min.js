...
!(function () {
            ...
            for (var n = 0; n < e.length; n++) {
                var r = (function (n) {
                    ...
                    return S(t, function (e) {
                        ...
                        return (
                            r ===
                            (null === (n = e.brand) || void 0 === n ? void 0 : n.toLowerCase())
                        );
                    }).map(function (e) {
                        return { current: e.name, version: he.nu(parseInt(n.version, 10), 0) };
                    });
                })(e[n]);
    ...
    function U(e) {
        ...
        return { target: i, x: e.clientX, y: e.clientY, stop: n, prevent: r, kill: u, raw: e };
    }
    function $(e, n, r) {
        return (
            (o = n),
            ...
            browsers: y([
                {
                    ...
                    search: function (e) {
                        return (
                            x(e, 'edge/') && x(e, 'chrome') && x(e, 'safari') && x(e, 'applewebkit')
                        );
                    }
                },
                {
