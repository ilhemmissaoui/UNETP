...
!(function () {
                        ...
                        if (J(t.map, 'data-ephox-embed-iri'))
                            ...
                            if (
                                ...
                                ('iframe' !== e &&
                                    ...
                                    'video' !== e &&
                                    'audio' !== e) ||
                                    (s.type || (s.type = e), (s = K.extend(t.map, s))),
                                'script' === e)
                            ) {
                                var r = b(i, t.map.src);
                                if (!r) return;
                    ...
                    if (o.map[t])
                        for (var n = o.length; n--; ) {
                            ...
                            a.name === t &&
                                (r
                                    ? ((o.map[t] = r), (a.value = r))
                                    : (delete o.map[t], o.splice(n, 1)));
                        }
                    else r && (o.push({ name: t, value: r }), (o.map[t] = r));
                })(e[a], a);
            }
        })(e);
    }
                    ...
                    start: function (e, t, r) {
                        if (!m.get())
                            if (J(t.map, 'data-ephox-embed-iri'))
                                m.set(!0),
                                    (n = c),
                                    ((i = (o = (a = t).map.style) ? ee.parseStyle(o) : {})[
                                        'max-width'
                                    ] = j(n.width)),
                                    (i['max-height'] = j(n.height)),
                                    O(a, { style: ee.serializeStyle(i) });
                            else {
                                switch (e) {
                                    case 'video':
                                    case 'object':
                                ...
                                if (s)
                                    switch (e) {
                                        ...
                                        case 'source':
                                            if (
                                                d < 2 &&
                                                (O(t, { src: c[te[d]], type: c[te[d] + 'mime'] }),
                                                !c[te[d]])
                                            )
                                                return;
                                            d++;
                            ...
                            if ('video' === e && s)
                                for (var t, r = 0; r < 2; r++)
                                    c[te[r]] &&
                                        (((t = []).map = {}),
                                        d <= r &&
                                            (O(t, { src: c[te[r]], type: c[te[r] + 'mime'] }),
                                            l.start('source', t, !0)));
                            var n;
                            c.poster &&
                                'object' === e &&
    ...
    function _(e, t) {
        for (
            var r,
                n =
                    (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && 'www.' !== r[1]
                        ? r[1]
                        : 'https://',
                a = e.regex.exec(t),
                o = n + e.url,
        ...
        return c
            ? ((a = t),
              ...
              new ne(function (t, e) {
                  function r(e) {
                      return (
                          e.html && (ae[a.source] = e), t({ url: a.source, html: e.html || o(a) })
                      );
                  }
                  ae[a.source] ? r(ae[a.source]) : i({ url: a.source }, r, e);
              }))
            : ((n = T(e)), ne.resolve({ html: n((r = t)), url: r.source }));
    }
    function D(e, t) {
        var r,
            n,
        ...
        e.insertContent(t),
            (function (e, t) {
                for (var r = e.dom.select('*[data-mce-object]'), n = 0; n < t.length; n++)
                    for (var a = r.length - 1; 0 <= a; a--) t[n] === r[a] && r.splice(a, 1);
    ...
    function N(m) {
        var e,
            ...
            o = {
                ...
                items: (function (e) {
                    ...
                    [{ name: 'source', type: 'urlinput', filetype: 'media', label: 'Source' }],
        ...
        0 < i.length && c.push({ title: 'Advanced', name: 'advanced', items: i });
        var h = m.windowManager.open({
            title: 'Insert/Edit Media',
            size: 'normal',
            body: { type: 'tabpanel', tabs: c },
            buttons: [
            ...
            onSubmit: function (e) {
                ...
                (t = d.get()),
                    ...
                    r.embed && (t.source === r.source || ((a = r.source), J(ae, a)))
                        ? z(n, r.embed)
                        : C(n, r)
                              .then(function (e) {
                                  z(n, e.html);
                    ...
                    start: function (e, t, r) {
                        if (((i = !0), 'script' !== e && 'noscript' !== e && 'svg' !== e)) {
                            for (var n = t.length - 1; 0 <= n; n--) {
                                var a = t[n].name;
                                0 === a.indexOf('on') && (delete t.map[a], t.splice(n, 1)),
                                    'style' === a &&
                                        (t[n].value = o.dom.serializeStyle(
                                            o.dom.parseStyle(t[n].value),
                                            e
                                        ));
                            }
                            c.start(e, t, r), (i = !1);
    ...
    function R(e, t, r) {
        var n = 'img' === t.name || 'video' === e.name,
            ...
            o = n ? a : null;
        t.attr({ width: E(e, r, 'width', n ? '300' : null), height: E(e, r, 'height', o) });
    }
    function L(e, t) {
        var r = t.name,
            n = new oe('span', 1);
        ...
        R(t, i, o),
            ...
            'iframe' === r
                ? i.attr({ allowfullscreen: t.attr('allowfullscreen'), frameborder: '0' })
                : (h(
                      [
                          'controls',
                          'crossorigin',
                  ...
                  s((a = n.attr('data-mce-html'))) &&
                      (function (e, t, r, n) {
                          for (
                              var a = ce({ forced_root_block: !1, validate: !1 }, e.schema).parse(
                                  n,
                                  { context: t }
                              );
                              a.firstChild;
        ...
        se = function (e, t, r) {
            for (var n = t.attributes, a = n.length; a--; ) {
                ...
                'width' !== o &&
                    'height' !== o &&
                    'style' !== o &&
                    (('data' !== o && 'src' !== o) || (i = e.convertURL(i, o)),
        ...
        return (
            ...
            (r = e).ui.registry.addToggleButton('media', {
                ...
                onSetup: function (e) {
                    var t = r.selection;
                    return (
                        e.setActive(A(t.getNode())),
                        t.selectorChangedWithUnbind(
            ...
            r.ui.registry.addMenuItem('media', { icon: 'embed', text: 'Media...', onAction: o }),
                            ...
                            if ((r = e[l]).parent) {
                                for (
                                    s = r.attr(t),
                                        ...
                                        a = (o = r.attributes).length;
                                    a--;

                                ) {
                                    var m = o[a].name;
                                    0 === m.indexOf('data-mce-p-') &&
                                        n.attr(m.substr(11), o[a].value);
                                }
            ...
            (n = e).on('click keyup touchend', function () {
                ...
                e &&
                    n.dom.hasClass(e, 'mce-preview-object') &&
                    n.dom.getAttrib(e, 'data-mce-selected') &&
            ...
            n.on('ObjectResized', function (e) {
                ...
                !r.getAttribute('data-mce-object') ||
                    ((t = r.getAttribute('data-mce-html')) &&
                        ...
                        r.setAttribute(
                            'data-mce-html',
                            escape(S(t, { width: String(e.width), height: String(e.height) }))
                        )));
            }),
            (a = e),
            {
