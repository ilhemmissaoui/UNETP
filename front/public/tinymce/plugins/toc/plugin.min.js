...
!(function () {
    ...
    function d(t) {
        ...
        for (var l = 0; l < r.length; l++) {
            ...
            if (c === a.level) i += '<li>';
            else for (var d = c; d < a.level; d++) i += '<ul><li>';
            if (((i += '<a href="#' + a.id + '">' + a.title + '</a>'), u !== a.level && u))
                for (d = a.level; u < d; d--) i += d === u + 1 ? '</li></ul><li>' : '</li></ul>';
            else (i += '</li>'), u || (i += '</ul>');
            c = a.level;
        }
        return i;
    ...
    e.add('toc', function (t) {
        ...
        (c = t).addCommand('mceInsertToc', function () {
            ...
            (o = a((t = c))),
                (i = t.$('.' + o)),
                (r = t),
                !i.length || 0 < r.dom.getParents(i[0], '.mce-offscreen-selection').length
                    ? t.insertContent(
                          ((n = d((e = t))),
                          '<div class="' +
                              e.dom.encode(a(e)) +
