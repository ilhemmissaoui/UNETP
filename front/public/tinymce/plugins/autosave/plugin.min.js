...
!(function () {
    ...
    function u(t) {
        ...
        return !(
            new Date().getTime() - e > o(t.getParam('autosave_retention'), '20m') && (g(t, !1), 1)
        );
    }
    function s(t) {
        var e = n(t);
    ...
    function f(t) {
        var e = n(t);
        u(t) && (t.setContent(v.getItem(e + 'draft'), { format: 'raw' }), t.fire('RestoreDraft'));
    }
    function c(t) {
    ...
    var t = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        g = function (t, e) {
            var r = n(t);
            v.removeItem(r + 'draft'), v.removeItem(r + 'time'), !1 !== e && t.fire('RemoveDraft');
        },
    ...
    t.add('autosave', function (t) {
        ...
        return (
            ...
            t.on('init', function () {
                t.getParam('autosave_restore_when_empty', !1) && t.dom.isEmpty(t.getBody()) && f(t);
            }),
            (r = t),
            {
                hasDraft: function () {
