...
!(function () {
    ...
    function M(t, n) {
        ...
        for (
            var e = t.cloneContents(), r = new dt(e.firstChild, e), o = [], i = e.firstChild;
    ...
    function I(t, n) {
        return (
            ...
            vt(n) ? t.dom.select('a[href]', n)[0] : t.dom.getParent(n, 'a[href]')
        );
    }
    function K(t, n) {
        return (n ? n.innerText || n.textContent : t.getContent({ format: 'text' })).replace(
            /\uFEFF/g,
            ''
        );
    }
    ...
    function q(t, n, e) {
        var r,
            ...
            g =
                ((r = t),
                (o = e.href),
                st(st({}, e), { href: ht.isDomSafe(o, 'a', r.settings) ? o : '' }));
        t.hasPlugin('rtc', !0)
            ? t.execCommand(
                  'createlink',
                  !1,
    ...
    function W(t) {
        var n = t.href;
        return 0 < n.indexOf('@') && -1 === n.indexOf('/') && -1 === n.indexOf('mailto:')
            ? it.some({
                  message:
        ...
        Tt(t, n)
            .then(function (t) {
                var n,
                    ...
                    f = n.anchor,
                    s = {
                        url: { value: (e = f.url.getOr('')), meta: { original: { value: e } } },
                        text: f.text.getOr(''),
                        title: f.title.getOr(''),
                        anchor: e,
                        link: e,
    ...
    function rt(t) {
        ...
        return 0 < n.length ? it.some([{ text: 'None', value: '' }].concat(n)) : it.none();
    }
    var ot = function (e) {
            function t() {
                return o;
        ...
        bt = function (t, c) {
            function f(t, n) {
                var e,
                    ...
                    a,
                    l = (
                        'link' === (e = n.name) ? c.link : 'anchor' === e ? c.anchor : it.none()
                    ).getOr([]);
                return (
                    (r = s.text),
                    (o = n.name),
                ...
                onChange: function (t, n) {
                    ...
                    return 'url' === l
                        ...
                        : ((e = ['anchor', 'link']),
                          -1 < ut.call(e, l)
                              ? f(t(), n)
                              : (('text' !== l && 'title' !== l) || (s[l] = t()[l]), it.none()));
                }
            };
        },
        ...
        Ct = function (u, a) {
            return b(
                [
                    ...
                    function (t) {
                        var n = t.href;
                        return (1 === e && !U(n)) || (0 === e && /^\s*www(\.|\d\.)/i.test(n))
                            ? it.some({
                                  message:
