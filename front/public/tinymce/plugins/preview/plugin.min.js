        ...
        (n = e).addCommand('mcePreview', function () {
            ...
            (t = (function (t) {
                ...
                var a,
                    ...
                    m,
                    y =
                        -1 === (c = (a = t).getParam('body_id', 'tinymce', 'string')).indexOf('=')
                            ? c
                            : (s = (r = a).getParam('body_id', '', 'hash'))[r.id] || s,
                    u =
                        -1 === (m = (d = t).getParam('body_class', '', 'string')).indexOf('=')
                            ? m
            ...
            t.ui.registry.addMenuItem('preview', { icon: 'preview', text: 'Preview', onAction: i });
    });
})();
