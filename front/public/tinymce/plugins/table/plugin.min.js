...
!(function () {
    ...
    var Re,
        ...
        Be = {
            browsers: C([
                {
                    ...
                    search: function (e) {
                        return (
                            Z(e, 'edge/') && Z(e, 'chrome') && Z(e, 'safari') && Z(e, 'applewebkit')
                        );
                    }
                },
                {
            ...
            oses: C([
                ...
                { name: 'Linux', search: te('linux'), versionRegexes: [] },
                { name: 'Solaris', search: te('sunos'), versionRegexes: [] },
                { name: 'FreeBSD', search: te('freebsd'), versionRegexes: [] },
                {
                    name: 'ChromeOS',
                    search: te('cros'),
        ...
        Me = 'Firefox',
        Ee = function () {
            return Se({ current: void 0, version: Oe.unknown() });
        },
        Pe = Se,
        ...
        We = 'ChromeOS',
        je = function () {
            return Te({ current: void 0, version: Oe.unknown() });
        },
        Fe = Te,
        He =
            (C(Ne),
            ...
            Y(function () {
                return (
                    ...
                    (n = q.from(navigator.userAgentData)),
                    (t = re),
                    (p = Be.browsers()),
                    (b = Be.oses()),
                    (h = n
    ...
    function dn(e, n) {
        return ue((t = void 0 === e ? document : e.dom))
            ? []
            : O(t.querySelectorAll(n), Ve.fromDom);
        var t;
    }
    ...
    var gn = Qe(1),
        ...
        Sn = function (e) {
            ...
            return (
                (o = Ve.fromDom(n)),
                (i = yn(o)),
                (hn((u = i)) && l(u.dom.host) ? q.some(i) : q.none()).fold(
                    function () {
    ...
    function $n(e, n) {
        var t,
            r = n;
        Fn((t = e.dom)) && t.style.removeProperty(r),
            Ln(Nn(e, 'style').map(ke), '') && Wt(e, 'style');
    }
    function Kn(e, n, t) {
        return (
            void 0 === t && (t = 0),
    ...
    function et(e, n) {
        return (
            (t = ['td', 'th']),
            (o = void 0 === (o = n) ? v : n)((r = e))
                ? q.none()
                : y(t, Ye(r))
                ? q.some(r)
                : On(r, t.join(','), function (e) {
    ...
    function vt(e) {
        ...
        A(r.fail, function (e) {
            ...
            A(e.cells, function (e) {
                ...
                t++,
                n.push(ve(e.element, c, e.section)),
                s++;
        });
        var u = F(o)
                .map(function (e) {
                    var o,
                        ...
                        n =
                            ...
                            o);
                    return { colgroups: [{ element: e.element, columns: de(n) }], columns: n };
                })
                .getOrThunk(function () {
                    return { colgroups: [], columns: {} };
                }),
            i = u.columns,
            c = u.colgroups;
        return { grid: { rows: t, columns: f }, access: l, all: n, columns: i, colgroups: c };
    }
    function wt(e, n) {
        var t = n.column,
    ...
    function Zt() {
        return {
            up: C({ selector: On, closest: In, predicate: Dn, all: on }),
            down: C({ selector: dn, predicate: xn }),
            styles: C({ get: Un, getRaw: Gn, set: Vn, remove: $n }),
            attrs: C({
                get: Pn,
                set: Mn,
                remove: Wt,
    ...
    function tr(c, l, a) {
        ...
        return ce(c, l)
            ? q.some({ boxes: q.some([c]), start: c, finish: l })
            : nr(c).bind(function (i) {
                  return nr(l).bind(function (u) {
                      ...
                      if (le(i, u)) {
                          ...
                          return q.some({ boxes: xt(i, c, i, l, u), start: c, finish: e });
                      }
                      if (le(u, i)) {
                          var n,
                              t = 0 < (n = sn(c, 'td,th', f(u))).length ? n[n.length - 1] : c;
                          return q.some({ boxes: xt(u, c, i, l, u), start: c, finish: t });
                      }
                      return Vr(qr, c, l, void 0).shared.bind(function (e) {
                          return In(e, 'table', a).bind(function (e) {
                              ...
                              return q.some({ boxes: xt(e, c, i, l, u), start: o, finish: t });
                          });
                      });
                      var r, o;
                  });
                ...
                return r.bind(function (e) {
                    return ce(i, e)
                        ? ((t = c.table),
                          ...
                          (o = c.last),
                          (u = Kt(t)),
                          Ct((n = u), r, o).bind(function (e) {
                              return (function (e, n) {
                                  for (
                                      var t = !0, r = P(yt, n), o = n.startRow;
                                      o <= n.finishRow;
                                      o++
                                  )
    ...
    function gr(e, n, t) {
        return (
            (r = Un(e, n)), (o = t), (u = parseFloat(r)), (isNaN(u) ? q.none() : q.some(u)).getOr(o)
        );
        var r, o, u;
    }
    function pr(e) {
    ...
    function br(e, n, t, r) {
        return (
            ...
            gr(e, 'padding-' + t, 0) -
            gr(e, 'padding-' + r, 0) -
            gr(e, 'border-' + t + '-width', 0) -
            gr(e, 'border-' + r + '-width', 0)
        );
    }
    function hr(e, n) {
        var t = e.dom,
    ...
    var _r,
        ...
        qr = Zt(),
        Ur = rr,
        Gr = Lr([{ none: [] }, { multiple: ['elements'] }, { single: ['element'] }]),
        $r = Gr.none,
        Kr = Gr.multiple,
        Xr = Gr.single,
        ...
        ro = function (e) {
            return dr()
                ? ((t = pr((n = e))),
                  (o = (r = n.dom).getBoundingClientRect().height || r.offsetHeight),
                  'border-box' === t ? o : br(n, o, 'top', 'bottom'))
                : gr(e, 'height', e.dom.offsetHeight);
            var n, t, r, o;
        },
        oo = function (t, r) {
            return {
        ...
        io = function (e) {
            ...
            return r === t
                ? uo(r.offsetLeft, r.offsetTop)
                : Sn(e)
                ? ((n = t.getBoundingClientRect()), uo(n.left, n.top))
                : uo(0, 0);
        },
        co = {
            delta: S,
                    ...
                    (function (t, r) {
                        ...
                        var e = t[r].fold(
                                function () {
                                    var e, n;
                                    return H(
                                        ((e = t.slice(0, r)), (n = U.call(e, 0)).reverse(), n),
                                        function (e, n) {
                                            return e.map(function (e) {
    ...
    function ko(e, n, i, c) {
        var l = yr(e),
            t = $t.hasColumns(e)
                ? O($t.justColumns(e), function (e) {
                      return q.from(e.element);
                  })
                : l,
            a = [q.some(ao.edge(n))].concat(
                O(ao.positions(l, n), function (e) {
                    return e.map(function (e) {
                        return e.x;
                    });
                })
        ...
        return O(t, function (e, u) {
            return Ao(
                ...
                function (e) {
                    return (
                        (t = e),
                        (o = (r = He().browser).isChrome() || r.isFirefox()),
                        !Hl(t) || o
                            ? i(e)
                            : Ao(
                                  null != (n = l[u]) ? S(n) : q.none(),
                                  u,
                                  a,
                                  f,
                                  function (e) {
    ...
    function Mo(e, n, t, r, o) {
        var u = Cr(e),
            i = [q.some(t.edge(n))].concat(
                O(t.positions(u, n), function (e) {
                    return e.map(function (e) {
                        return e.y;
                    });
                })
    ...
    function zo(e, n) {
        ...
        var u,
            ...
            w =
                ...
                { minRow: i, minCol: c, maxRow: l, maxCol: a, allCells: f, selectedCells: s }),
            y = 'th:not(' + n + '),td:not(' + n + ')';
        return (
            A(
                Vt(p, 'th,td', function (e) {
                    return oe(e, y);
                }),
                Yt
            ),
    ...
    function $o(a, f, s) {
        function m(e, n) {
            var t = e.element.dom,
                r = n.dom;
            Fn(t) && Fn(r) && (r.style.cssText = t.style.cssText),
                $n(n, 'height'),
            ...
            mergable:
                ...
                cr(
                    ...
                    function (n) {
                        return n.length <= 1
                            ? q.none()
                            : ir(u, i.firstSelectedSelector, i.lastSelectedSelector).map(function (
                                  e
                              ) {
                                ...
                                .each(function (e) {
                                    ...
                                    t.content =
                                        'text' === t.format
                                            ...
                                            : ((n = a),
                                              O(e, function (e) {
                                                  return n.selection.serializer.serialize(
                                                      e.dom,
                                                      {}
                                                  );
                                              }).join(''));
    ...
    function lu(e, n, t) {
        ...
        A(
            ...
            $t.hasColumns(r)
                ? ((i = o),
                  O($t.justColumns(r), function (e, n) {
                      return { element: e.element, width: i[n], colspan: e.colspan };
                  }))
                : ((u = o),
                  O($t.justCells(r), function (e) {
    ...
    function du() {
        ...
        function c(e, n, t, r, o, u) {
            return u
                ? f(e, n, r, o)
                : ((l = t), (a = na((i = e), (c = n), r, o)), su(i, c, l + 1, [a, 0], fu));
            var i, c, l, a;
        }
        return {
    ...
    function Ru(e) {
        return (function (r, o, u) {
            ...
            return (
                (function (n, e) {
                    if (!a(e))
                        throw new Error('The ' + n + ' fields must be an array. Was: ' + e + '.');
                    A(e, function (e) {
                        if (!T(e))
                            throw new Error(
        ...
        })(xu, e, { validate: c, label: 'function' });
    }
    function Du() {
        var u,
            i,
            e = { onEvent: E, reset: E, events: Su({ move: Cu(['info']) }).registry },
            n =
                ((u = q.none()),
                {
                    ...
                    events: (i = Su({ move: Cu(['info']) })).registry
                }),
            t = e;
        return {
            on: function () {
    ...
    function Ou(e) {
        ...
        return { target: u, x: e.clientX, y: e.clientY, stop: n, prevent: t, kill: i, raw: e };
    }
    function Au(e, n, t) {
        return (
            (o = n),
    ...
    function Iu(e, n) {
        return (
            ...
            Mn(
                e,
                (t = 'class'),
                (void 0 === (r = Pn(e, t)) || '' === r ? [] : r.split(' ')).concat([o]).join(' ')
            ),
            1
        );
        var t, r, o;
    ...
    function Nu(e, n) {
        return (
            void 0 === n && (n = !1),
            !He().browser.isIE() && Sn(e)
                ? e.dom.isContentEditable
                : Pu(e).fold(C(n), function (e) {
                      return 'true' === pa(e);
                  })
        );
    }
            ...
            Lu(i, c, function (e, n) {
                var t,
                    ...
                    c =
                        ...
                        En(i, { 'data-row': t, role: 'presentation' }),
                        i);
                return Bu(c, va), c;
            });
        var p,
            ...
            Lu(v, w, function (e, n) {
                var t,
                    ...
                    c =
                        ...
                        En(i, { 'data-column': t, role: 'presentation' }),
                        i);
                return Bu(c, wa), c;
            });
    }
    ...
    function Vu(o) {
        ...
        var n,
            ...
            c,
            l =
                ((u = Su({ drag: Cu(['xDelta', 'yDelta', 'target']) })),
                (i = q.none()),
                (c = {
                    mutate: function (e, n) {
                        r.trigger.drag(e, n);
                    },
                    events: (r = Su({ drag: Cu(['xDelta', 'yDelta']) })).registry
    ...
    function Gu(e, n, t) {
        e.fire('TableModified', K(K({}, t), { table: n }));
    }
    function $u(e) {
        ...
        return e.getParam(
            ...
            (function (e) {
                ...
                if (ka(e)) {
                    var t = e.dom,
                        r =
                            null !== (n = t.getParent(e.selection.getStart(), t.isBlock)) &&
                            void 0 !== n
                                ? n
                                : e.getBody(),
                        o = Qr(Ve.fromDom(r));
                    return K(K({}, xa), { width: o + 'px' });
                }
                return Ia(e)
                    ? se(xa, function (e, n) {
                          return 'width' !== n;
    ...
    function bi(p) {
        ...
        return (
                    ...
                    g =
                        ...
                        (e = p).inline
                            ? ((u = Yo(e)),
                              ...
                              Xt(Tn(Ve.fromDom(document)), c),
                              c,
                              (i = n),
                              { parent: C(c), view: C(u), origin: C(uo(0, 0)), isResizable: i })
            ...
            p.on('ObjectResizeStart', function (e) {
                ...
                m(u) &&
                    ((n = Ve.fromDom(u)),
                    A(p.dom.select('.mce-clonedresizable'), function (e) {
                        p.dom.addClass(e, 'mce-' + ci(p) + '-columns');
                    }),
                    !Ml(n) && ka(p) ? Ma(n) : !Bl(n) && ui(p) && Ba(n),
                    El(n) && Ae(e.origin, Pa) && Ba(n),
                    (d = e.width),
                    (g = Ia(p)
                        ? ''
                        : ((o =
                              (t = p).dom.getStyle((r = u), 'width') ||
                              t.dom.getAttrib(r, 'width')),
                          q.from(o).filter(ne).getOr(''))));
            }),
                    ...
                    Ae(t, 'corner-') &&
                        ...
                        o !== d && '' !== g
                            ? (Vn(r, 'width', g),
                              (u = h()),
                              (i = b(r)),
                              (c = li(p) || f ? yu(r).columns - 1 : 0),
                              au(r, o - d, c, u, i))
                            : /^(\d+(\.\d+)?)%$/.test(g) &&
                              Vn(r, 'width', (o * parseFloat(g.replace('%', ''))) / d + '%'),
                        /^(\d+(\.\d+)?)px$/.test(g) &&
                            ((a = $t.fromTable((l = r))),
                            $t.hasColumns(a) ||
                                A(nt(l), function (e) {
            ...
            yo(t)
                .bind(function (e) {
                    return (
                        ...
                        q.from(so.exec(e)).bind(function (e) {
                            var n = Number(e[1]),
                                t = e[2],
                                r = t;
    ...
    function Ci(e) {
        var n = 'thead' === e.section,
            t = Ln(ja(e.cells), 'th');
        return n || t
            ? { type: 'header', subType: n && t ? 'sectionCells' : n ? 'section' : 'cells' }
            : 'tfoot' === e.section
            ? { type: 'footer' }
            : { type: 'body' };
    }
    ...
    function xi() {
        return {
            ...
            transformCell: function (e, n, t) {
                ...
                return we(
                    'td' !== Ye(u)
                        ? ((o = sr((r = u), 'td')), Rt(r, o), It(o, ln(r)), Yt(r), o)
                        : u,
                    e.isNew,
                    e.isLocked
                );
    ...
    function Ri() {
        return { transformRow: Ti, transformCell: Si };
    }
    function Di() {
        return {
    ...
    function ki(u, e) {
        function t(e, n) {
            ...
            It(
                (Bt(
                    (o = An((t = u), (r = n)).getOrThunk(function () {
                        var e = Ve.fromTag(r, nn(t).dom);
                        return (
                            'thead' === r
                                ? Ai(t, 'caption,colgroup', e)
                                : 'colgroup' === r
                                ? Ai(t, 'caption', e)
                                : Xt(t, e),
                            e
                              ...
                              return (
                                  ...
                                  A(e.cells, function (e) {
                                      e.isNew && c.push(e.element),
                                          Oi(e.element, 'colspan', e.colspan, 1),
                                          Oi(e.element, 'rowspan', e.rowspan, 1),
                                          Xt(n, e.element);
                                  }),
                                  n
                              );
        ...
        return O(m, function (e, s) {
            var n = N(e.cells, function (e, n) {
                ...
                return (
                    (function (e, n, t, r) {
                        for (var o = e; o < e + t; o++)
                            for (var u = n; u < n + r; u++) g[o][u] = !0;
                    })(s, n, f.rowspan, f.colspan),
                    [{ element: e.element, rowspan: f.rowspan, colspan: f.colspan, isNew: e.isNew }]
                );
            });
            return { element: e.element, cells: n, section: e.section, isNew: e.isNew };
        });
    }
    function Mi(o, u, i) {
        var c = [];
            ...
            return n(l, e)
                .map(function (e) {
                    var n = Mi(l, i, !1),
                        t = f(n, e, ce, d(i), a),
                        r = ht(t.grid);
                    return { info: e, grid: Ei(t.grid), cursor: t.cursor, lockedColumns: r };
                })
                .bind(function (e) {
                    var n = ki(u, e.grid),
                    ...
                    return (
                        ...
                        Wu(o, u),
                        Wt(u, Gt),
                        0 < e.lockedColumns.length && Mn(u, Gt, e.lockedColumns.join(',')),
                        q.some({ cursor: e.cursor, newRows: n.newRows, newCells: n.newCells })
                    );
                });
        };
    }
                            ...
                            for (var n = 0; n < dt(l[0]); n++)
                                !(function (n) {
                                    ...
                                    i(r.element, e.element) &&
                                        (o = o.isNone() ? q.some(c()) : o).each(function (e) {
    ...
    function Ui(e, n) {
        return { rowDelta: 0, colDelta: dt(e[0]) - dt(n[0]) };
    }
    function Gi(e, n) {
    ...
    function Qi(e, u, n, i, c) {
        var t,
            ...
            s = Ji(a, f, l);
        return (function (e, n, t) {
            if (e.row >= n.length || e.column > dt(n[0]))
                return Ga.error(
            ...
            var r = n.slice(e.row),
                ...
                u = dt(t[0]),
                i = t.length;
            return Ga.value({ rowDelta: r.length - i, colDelta: o.length - u });
        })(a, u, f).map(function (e) {
            var n = K(K({}, e), { colDelta: e.colDelta - s.length }),
                t = Yi(u, n, i),
                r = ht(t),
                o = Ji(a, f, r);
                ...
                for (
                    ...
                    for (var h, v, w, y = 0, C = m; C < g; C++)
                        p[C]
                            ...
                            : ((l = C),
                              (a = void 0),
                              (a = P(o, st((i = n)[(c = b)], l).element)),
                              (f = i[c]),
                              1 < i.length &&
                                  1 < dt(f) &&
                                  ((0 < l && a(mt(f, l - 1))) ||
                                      (l < f.cells.length - 1 && a(mt(f, l + 1))) ||
                                      (0 < c && a(mt(i[c - 1], l))) ||
                                      (c < i.length - 1 && a(mt(i[c + 1], l)))) &&
                                  Vi(n, mt(n[b], C), o, r.cell),
                              (v = (h = st(t[b - s], C - m - y)).element),
                              (w = r.replace(v)),
                              ft(n[b], C, we(w, !0, h.isLocked)));
                return n;
            })(a, t, f, i, c, o);
        });
    }
    ...
    function ec(e, n, t, r, o) {
        ...
        var u,
            ...
            c = ht(n),
            l = Ui(n, t),
            a = Yi(n, K(K({}, l), { colDelta: l.colDelta - c.length }), r),
            f = gt(a),
            s = f.cols,
            m = f.rows,
            d = ht(a),
            g = Ui(t, n),
            p = K(K({}, g), { colDelta: g.colDelta + d.length }),
            b = Yi(
                ((u = r),
                (i = d),
                O(t, function (t) {
    ...
    function nc(e, t, n, r, o) {
        var u,
            ...
            g =
                ((u = f[n]),
                (i = function (e, n) {
                    return 0 < t && t < f.length && r(mt(f[t - 1], n), mt(f[t], n))
                        ? st(f[t], n)
                        : we(o(e.element, r), !0, e.isLocked);
                }),
                (c = r),
                (l = o),
                pt(
        ...
        return O(e, function (e) {
            var n,
                ...
                o =
                    ((n = e.section),
                    (t = l),
                    'colgroup' !== n && r ? st(e, u) : we(t(st(e, i).element, c), !0, !1));
            return at(e, u, o);
        });
    }
    function rc(e, n, t, r) {
        return (
            (void 0 !== mt((u = e)[(i = n)], t) && 0 < i && r(mt(u[i - 1], t), mt(u[i], t))) ||
            ((o = e[n]), 0 < t && r(mt(o, t - 1), mt(o, t)))
        );
        var o, u, i;
    }
    function oc(e, n, t, r) {
            ...
            return (
                (t = function (e, n) {
                    if (
                        ...
                        return (
                            a(r, o, n).each(function (e) {
                                var t = r.element;
                                ae({ scope: q.from(e) }, function (e, n) {
                                    e.fold(
                                        function () {
                                            Wt(t, n);
                                        },
                ...
                (r = O((n = e).cells, t)),
                ye(n.element, r, n.section, n.isNew)
            );
            var n, t, r;
        });
    }
    ...
    function mc(e) {
        return { element: e, colspan: Kn(e, 'colspan', 1), rowspan: Kn(e, 'rowspan', 1) };
    }
    function dc(e) {
                    ...
                    var r = cn(t)
                        .map(function (e) {
                            return (
                                !!gc(e) ||
                                ((n = e),
                                !!y(['br', 'img', 'hr', 'input'], Ya.property().name(n)) &&
                                    'img' !== Ye(e))
                            );
                            var n;
                        })
    ...
    function yc(e, n, t) {
        var r,
            ...
            l =
                ...
                q
                    .from(
                        null === (i = null === (u = c[r]) || void 0 === u ? void 0 : u.cells[o]) ||
                            void 0 === i
                            ? void 0
                            : i.element
                    )
    ...
    function kc(t) {
        return function (n, e) {
            return _i(n, e)
                ...
                .map(function (e) {
                    return { details: e, pixelDelta: Ac(n, e) };
                });
        };
    }
    function Ic(t) {
            ...
            return function (t, e, o) {
                            ...
                            switch (ii(m)) {
                                ...
                                default:
                                    return (function (e, n) {
                                        var t;
                                        switch (
                                            H($t.fromTable(e).all, function (e) {
                                                var n = Ci(e);
                ...
                return l(t)
                    ? c(n, t, e, u, i).bind(function (e) {
                                      ...
                                      function () {
                                          return j(nt(r))
                                              ...
                                              .map(function (e) {
                                                  ...
                                                  return (
                                                      n.selectNode(e.dom),
                                                      m.selection.setRng(n),
                                                      Mn(e, 'data-mce-selected', '1'),
                                                      n
                                                  );
                                              });
                                      },
                          ...
                          return (
                              Sn(t) && (nu(t), o || Gu(m, t.dom, s)),
                              n.map(function (e) {
                                  return { rng: e, effect: s };
                              })
                          );
                      })
                    : q.none();
            ...
            u.undoManager.ignore(function () {
                var e = (function (e, n, t, r, o, u) {
                    ...
                    a &&
                        ...
                        ((f = Ve.fromTag('thead')),
                        Xt(l, f),
                        It(f, Pc(t, n, 'sectionCells' === o ? s : 0, r)));
                ...
                var n,
                    ...
                    o =
                        ((n = e),
                        (t = Ve.fromTag('div')),
                        (r = Ve.fromDom(n.dom.cloneNode(!0))),
                        Xt(t, r),
                        t.dom.innerHTML);
                u.insertContent(o), u.addVisual();
            }),
            kn(Yo(u), 'table[data-mce-id="__mce"]')
                .map(function (e) {
                    var n, t, r;
                    return (
                        ka(u)
                            ...
                            : Ia(u)
                            ? Ea(e)
                            : (ui(u) || ((n = o.width), T(n) && -1 !== n.indexOf('%'))) && Ba(e),
                        nu(e),
                        Wt(e, 'data-mce-id'),
                        (t = u),
                        A(dn(e, 'tr'), function (e) {
                            qu(t, e.dom),
                                A(dn(e, 'th,td'), function (e) {
                                    Uu(t, e.dom);
                                });
                        }),
                        (r = u),
                        kn(e, 'td,th').each(P(Nc, r)),
                        e.dom
                    );
                })
                .getOr(null)
    ...
    function qc(e) {
        return Of.test((t = e)) || Af.test(t)
            ? q.some({ value: (Ae((n = e), '#') ? n.substring('#'.length) : n).toUpperCase() })
            : q.none();
        var n, t;
    }
    function Uc(e) {
    ...
    function Gc(e) {
        return { value: Uc(e.red) + Uc(e.green) + Uc(e.blue) };
    }
    function $c(e, n, t, r) {
    ...
    function tl(n) {
        return function () {
            ...
            n.execCommand('mceTableRowType', !1, { type: 'header' === e ? 'body' : 'header' });
        };
    }
    function rl(n) {
        return function () {
    ...
    function ol(e) {
        return Pf.concat(
            (0 < (n = Bf(ri(e))).length
                ? q.some({ name: 'class', type: 'listbox', label: 'Class', items: n })
                : q.none()
            ).toArray()
        );
        var n;
    ...
    function ul(e, n) {
        var t = [
            {
                ...
                type: 'listbox',
                label: 'Border style',
                items: [{ text: 'Select...', value: '' }].concat(Bf(Yu(e)))
            },
        ...
        return {
            ...
            items:
                'cell' === n
                    ? [{ name: 'borderwidth', type: 'input', label: 'Border width' }].concat(t)
                    : t
        };
    }
    function il(u) {
                        ...
                        (t || Ke(c, 'scope')) &&
                            ...
                            A(n, function (e) {
                                ...
                                (n = l).setAttrib('scope', f.scope),
                                    ...
                                    n.setStyle('height', eu(f.height)),
                                    a.setStyle('width', eu(f.width)),
                                    Zu(s) &&
                                        ((t = l).setFormat(
                                        ...
                                        t.setFormat('tablecellborderwidth', eu(r.borderwidth))),
                                    d &&
                                        (Vc(s, c),
                                        (o = s),
                                        (u = c),
                                        Rf.each('top middle bottom'.split(' '), function (e) {
                                            o.formatter.remove('valign' + e, {}, u);
                                        })),
                                    m.halign && Hc(s, c, m.halign),
                                    !m.valign ||
                            ...
                            Gu(u, e.dom, { structure: r, style: t });
                    }),
                    e.focus();
            });
    }
    function dl(e, n) {
        ...
        0 !== i.length &&
            ...
            (o = {
                type: 'tabpanel',
                tabs: [{ title: 'General', name: 'general', items: ol(e) }, ul(e, 'cell')]
            }),
            (u = { type: 'panel', items: [{ type: 'grid', columns: 2, items: ol(e) }] }),
    ...
    function gl(e) {
        return _f.concat(
            (0 < (n = Bf(e.getParam('table_row_class_list', [], 'array'))).length
                ? q.some({ name: 'class', type: 'listbox', label: 'Class', items: n })
                : q.none()
            ).toArray()
        );
                    ...
                    (t = !n || 1 < ge(f)) &&
                        ...
                        A(o, function (e) {
                            ...
                            (n = o).setAttrib('class', u.class),
                                n.setStyle('height', eu(u.height)),
                                ei(i) &&
                                    ((t = o).setStyle('background-color', (r = c).backgroundcolor),
                                    t.setStyle('border-color', r.bordercolor),
                                    t.setStyle('border-style', r.borderstyle)),
                                c.align !== l.align && (Vc(i, e), Hc(i, e, c.align));
                        })),
                    n && r.execCommand('mceTableRowType', !1, { type: e.type, no_events: !0 }),
                    rt(Ve.fromDom(o[0])).each(function (e) {
                        return Gu(r, e.dom, { structure: n, style: t });
                    })),
                    s.focus();
            });
    }
    function bl(i) {
        ...
        0 !== l.length &&
                        ...
                        K(
                            {
                                ...
                                type: rt(Ve.fromDom((o = t)))
                                    .map(function (e) {
                                        var n = { selection: Xo(o.cells) };
                                        return Tf(e, n);
                                    })
                                    .getOr(''),
                                align: zf(n, t)
            ...
            (u = {
                type: 'tabpanel',
                tabs: [{ title: 'General', name: 'general', items: gl(i) }, ul(i, 'row')]
            }),
            (c = { type: 'panel', items: [{ type: 'grid', columns: 2, items: gl(i) }] }),
                ...
                i ||
                    ...
                    0 < ge(a) &&
                        ((function (e, n, t) {
                            ...
                            if (
                                ((u.class = t.class),
                                (i.height = eu(t.height)),
                                o.getAttrib(n, 'width') && !ti(e)
                                    ? (u.width = (r = t.width) ? r.replace(/px$/, '') : '')
                                    : (i.width = eu(t.width)),
                                ti(e)
                                    ? ((i['border-width'] = eu(t.border)),
                                      (i['border-spacing'] = eu(t.cellspacing)))
                                    : ((u.border = t.border),
                                ...
                                for (var c = 0; c < n.children.length; c++)
                                    Wf(o, n.children[c], {
                                        ...
                                        ni(e) &&
                                            Wf(o, n.children[c], { 'border-color': t.bordercolor });
                            ni(e) &&
                                ((i['background-color'] = t.backgroundcolor),
                                (i['border-color'] = t.bordercolor),
                                (i['border-style'] = t.borderstyle)),
                                (u.style = o.serializeStyle(K(K({}, Qu(e)), i))),
                                o.setAttribs(n, K(K({}, Ju(e)), u));
                        })(u, i, l),
                        (((t = c.select('caption', i)[0]) && !l.caption) || (!t && l.caption)) &&
                            u.execCommand('mceTableToggleCaption'),
                        '' === l.align ? Vc(u, i) : Hc(u, i, l.align)),
                    u.focus(),
                    u.addVisual(),
                    0 < ge(a) &&
                        ((o = !(r = Ke(a, 'caption')) || 1 < ge(a)),
                        Gu(u, i, { structure: r, style: o }));
            });
    }
    function vl(e, n) {
        var t,
        ...
        !1 === n
            ? (t = C.getParent(e.selection.getStart(), 'table', e.getBody()))
                ? ((d = t),
                  ...
                  (y = ti(m)
                      ? Fc(v, d, 'padding') || v.getAttrib(d, 'cellpadding')
                      : v.getAttrib(d, 'cellpadding') || Fc(v, d, 'padding')),
                  (S = K(
                      {
                          ...
                          border:
                              ((p = v),
                              (h = Gn(Ve.fromDom((b = d)), 'border-width')),
                              ti(m) && h.isSome()
                                  ? h.getOr('')
                                  : p.getAttrib(b, 'border') ||
                                    Fc(m.dom, b, 'border-width') ||
                                    Fc(m.dom, b, 'border')),
                ...
                : ni(e) && ((S.borderstyle = ''), (S.bordercolor = ''), (S.backgroundcolor = ''))
            : ((S.cols = '1'),
              (S.rows = '1'),
              ni(e) && ((S.borderstyle = ''), (S.bordercolor = ''), (S.backgroundcolor = '')));
        var T = Bf(oi(e));
        ...
        var x,
                    ...
                    (D = e.getParam('table_appearance_options', !0, 'boolean')
                        ? [
                              ...
                              { type: 'input', name: 'border', label: 'Border width' },
                              {
                                  ...
                                  label: 'Caption',
                                  items: [
                                      { type: 'checkbox', name: 'caption', label: 'Show caption' }
                                  ]
                              }
                          ]
                        : []),
            ...
            k = ni(e)
                ? {
                      type: 'tabpanel',
                      tabs: [{ title: 'General', name: 'general', items: [A] }, ul(e, 'table')]
                  }
                : { type: 'panel', items: [A] };
        e.windowManager.open({
    ...
    function yl(l, n, e, a, t) {
        ...
        function o() {
            return f(function (e, n) {
                ...
                return (
                    (t = u),
                    (r = i),
                    _i((o = $t.fromTable(e)), t)
                        .bind(function (e) {
                            var n = Ei(
                                N(
                                    gt(Mi(o, r, !1)).rows.slice(
                                        e[0].row,
                        ...
                        .map(function (e) {
                            return O(e, function (e) {
                                ...
                                return (
                                    A(e.cells, function (e) {
                                        var n = fr(e.element);
                                        Oi(n, 'colspan', e.colspan, 1),
                                            Oi(n, 'rowspan', e.rowspan, 1),
                                            Xt(t, n);
                                    }),
                                    t
                                );
        ...
        function i() {
            return f(function (e, n) {
                ...
                return (
                    (t = r),
                    Wi((l = $t.fromTable(e)), t).map(function (e) {
                        var r,
                            o,
                            n = e[e.length - 1],
                            t = e[0].column,
            ...
            return e().each(function (e) {
                ...
                f(function (e, n) {
                    var t,
                        ...
                        u = ((t = i), (r = o), { selection: ru(a), clipboard: t, generators: r });
                    c(e, u).each(s);
                });
            });
        }
        ...
        ae(
            {
                ...
                mceTableToggleClass: function (e, n) {
                    f(function (e) {
                        l.formatter.toggle('tableclass', { value: n }, e.dom), Gu(l, e.dom, Ca);
                    });
                },
                ...
                mceTableSizingMode: function (e, n) {
                    return (
                        (t = n),
                        wl(l).each(function (e) {
                            Ia(l) ||
                                ka(l) ||
                                ui(l) ||
                                rt(e, d).each(function (e) {
                                    'relative' !== t || Bl(e)
                                        ? 'fixed' !== t || Ml(e)
                                            ? 'responsive' !== t || El(e) || Ea(e)
                                            : Ma(e)
                                        : Ba(e),
                                        nu(e),
                                        Gu(l, e.dom, Sa);
    ...
    function Pl() {
        return { transformRow: S, transformCell: Si };
    }
    function Nl(o, u) {
        function r(e) {
            if (sc(e)) return Ka((t = { element: e }).element) ? o.colgroup(t) : o.row(t);
            var n,
                t,
                r = ((n = u(e)), $a(n.element) ? o.col(n) : o.cell(n));
            return (i = q.some({ item: e, replacement: r })), r;
        }
        void 0 === u && (u = mc);
        var i = q.none();
        return {
    ...
    function zl(r) {
        return function (t) {
            function u(e) {
                var n = t.replace(e, r, 'td' === r ? { scope: null } : {});
                return i.push({ item: e, sub: n }), n;
            }
            var i = [];
            return {
    ...
    var _l = /(\d+(\.\d+)?)%/,
        ...
        ta = mu(x),
        ra = Lr([{ invalid: ['raw'] }, { pixels: ['value'] }, { percent: ['value'] }]),
        oa = K(K({}, ra), {
            from: function (e) {
                return ee(e, '%')
                    ? pu('%', ra.percent, e)
        ...
        ua = function (e) {
            ...
            var n,
                ...
                r = I(
                    e,
                    function (e, n) {
                        var t = oa.from(n).fold(
                            function () {
                                return { value: n, remainder: 0 };
                            },
                            function (e) {
                                return (
                                    (n = e), { value: (t = Math.floor(n)) + 'px', remainder: n - t }
                                );
                                var n, t;
                            },
                            function (e) {
        ...
        ga = ca({
            ...
            sink: function (e, n) {
                var t,
                    ...
                    u =
                        ((t = n),
                        (r = K({ layerClass: da('blocker') }, t)),
                        Mn((o = Ve.fromTag('div')), 'role', 'presentation'),
                        qn(o, {
                            position: 'fixed',
                            left: '0px',
                            top: '0px',
        ...
        Ca = { structure: !1, style: !0 },
        Sa = { structure: !0, style: !1 },
        Ta = { structure: !0, style: !0 },
        ...
        Pa = 'bar-',
        Na = function (n, e, t) {
            return (n.property().isText(e) && 0 === n.property().getText(e).trim().length) ||
        ...
        vf = zi(
            function (e, n, t, r) {
                ...
                return Qi({ row: n.row, column: n.column }, e, i, n.generators, t).fold(
                    function () {
            ...
            function (n, t) {
                return et(t.element).bind(function (e) {
                    return Pi(n, e).map(function (e) {
                        return K(K({}, e), { generators: t.generators, clipboard: t.clipboard });
                    });
                });
            },
            xc,
        ...
        wf = zi(
            function (e, n, t, r) {
                var o = gt(e).rows,
                    ...
                    i = o[n.cells[0].row];
                return yc(
                    Zi(u, e, Tc(n.clipboard, n.generators, i), n.generators, t),
                    n.cells[0].row,
                    n.cells[0].column
                );
            },
        ...
        Cf = zi(
            function (e, n, t, r) {
                var o = gt(e).rows,
                    ...
                    i = o[u];
                return yc(
                    ec(u, e, Tc(n.clipboard, n.generators, i), n.generators, t),
                    n.cells[0].row,
                    n.cells[0].column
                );
            },
        ...
        Bf = function (e) {
            return O(e, function (e) {
                ...
                return Qc(e) ? { text: n, items: Bf(e.menu) } : { text: n, value: e.value };
            });
        },
        Mf = function (t, r, e, o, a) {
            return O(e, function (e) {
                var u,
                    i,
                    c,
        ...
        Ef = function (e) {
            return N(e, function (e) {
                return Qc(e) ? [K(K({}, e), { menu: Ef(e.menu) })] : ne(e.value) ? [e] : [];
            });
        },
        Pf = [
            ...
            { name: 'valign', type: 'listbox', label: 'Vertical align', items: Df }
        ],
        Nf = { normal: il(!1), ifTruthy: il(!0) },
        ...
        Wf = function (e, n, t, r) {
            if ('TD' === n.tagName || 'TH' === n.tagName)
                T(t) ? e.setStyle(n, t, r) : e.setStyle(n, t);
            else if (n.children)
                for (var o = 0; o < n.children.length; o++) Wf(e, n.children[o], t, r);
        },
        jf = { remove_similar: !0, inherit: !1 },
        Ff = K({ selector: 'td,th' }, jf),
        Hf = {
            tablecellbackgroundcolor: K({ styles: { backgroundColor: '%value' } }, Ff),
            tablecellverticalalign: K({ styles: { 'vertical-align': '%value' } }, Ff),
            tablecellbordercolor: K({ styles: { borderColor: '%value' } }, Ff),
            tablecellclass: K({ classes: ['%value'] }, Ff),
            tableclass: K({ selector: 'table', classes: ['%value'] }, jf),
            tablecellborderstyle: K({ styles: { borderStyle: '%value' } }, Ff),
        ...
        $f = Lr([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
        Kf = {
            before: $f.before,
            on: $f.on,
            after: $f.after,
    ...
    function ps(e) {
        ...
        return (
            ...
            (c = r),
            (l = o),
            (a = nn((u = n)).dom.createRange()).setStart(u.dom, i),
            a.setEnd(c.dom, l),
            (f = a),
            (s = ce(n, r) && t === o),
            f.collapsed && !s ? q.some(Gf(m, e.anchorOffset, d, e.focusOffset)) : gs(e)
        );
    }
    function bs(e, n, t) {
    ...
    function As(e, n) {
        return { left: e.left, top: e.top + n, right: e.right, bottom: e.bottom + n };
    }
    function ks(e, n) {
        return { left: e.left, top: e.top - n, right: e.right, bottom: e.bottom - n };
    }
    function Is(e, n, t) {
        return { left: e.left + n, top: e.top + t, right: e.right + n, bottom: e.bottom + t };
    }
    function Bs(e) {
    ...
    function Ps(e, n) {
        return gn(n)
            ? Ms(e, n).map(Bs)
            : pn(n)
            ? e.getRangedRect(n, 0, n, Lo(n)).map(Bs)
            : q.none();
    }
    function Ns(n, e, r) {
        return Rn(
                    ...
                    Dn(
                        ...
                        ? ((o = t = a),
                          ...
                          o
                              .getSelection()
                              .bind(function (r) {
                                  return Os(u, r.finish, r.foffset, i).fold(
                                      function () {
        ...
        return {
            ...
            getRangedRect: function (e, n, t, r) {
                var o,
                    ...
                    c = Yf.exact(e, n, t, r);
                return (
                    (i = (o = kl(l, c)).getClientRects()),
                    0 < (u = 0 < i.length ? i[0] : o.getBoundingClientRect()).width || 0 < u.height
                        ? q.some(u).map(Dl)
                        : q.none()
                );
            },
    ...
    var Ys = function (e, n, t, r) {
            return pn(n)
                ? ((u = n),
                  (i = t),
                  (c = r),
                  (l = (o = e).dom.createRange()).selectNode(u.dom),
                  H(l.getClientRects(), function (e) {
                ...
                : ((f = n),
                  ...
                  H(ln(f), function (e) {
                      return (
                          d.selectNode(e.dom),
                          Zf(d.getBoundingClientRect(), s, m) ? Ys(a, e, s, m) : q.none()
                      );
                  }));
        ...
        tm = function (e, n, t, r) {
            return { start: Kf.on(e, n), finish: Kf.on(t, r) };
        },
        rm = tm,
        om = function (t, e, r, n, o) {
            return ce(r, n)
                ? q.none()
                : tr(r, n, e).bind(function (e) {
                      var n = e.boxes.getOr([]);
                      return 1 < n.length
                          ? (o(t, n, e.start, e.finish), q.some(nm(q.some(rm(r, 0, r, Lo(r))), !0)))
                          : q.none();
                  });
        },
        um = function (e, n, t, r) {
        ...
        im = [
            { current: Cs, next: Ks, fallback: q.none() },
            { current: Ks, next: um, fallback: q.some(Cs) },
            { current: um, next: um, fallback: q.some(Ks) }
        ],
        cm = function (n, t, r, o, e) {
        ...
        lm = function (n, e, t, r, o, u) {
            return cm(n, e, r, o).bind(function (e) {
                return u(e.item)
                    ? q.none()
                    : t(e.item)
                    ? q.some(e.item)
                    : lm(n, e.item, t, e.mode, o, u);
            });
        },
        am = function (e, n, t, r) {
            return lm(
        ...
        ym = function (r, o, u, i, c, l) {
            return 0 === l
                ? q.none()
                : Tm(r, o, u, i, c).bind(function (e) {
                      var n = r.fromSitus(e),
        ...
        Dm = Vs(38),
        Om = Vs(40),
        Am = { isBackward: Vs(37), isForward: Vs(39) },
        km = { isBackward: Vs(39), isForward: Vs(37) },
                    ...
                    rt(a).each(function (e) {
                        var n,
                            ...
                            i =
                                ((n = c),
                                (o = r),
                                _i((u = $t.fromTable(e)), n).map(function (e) {
                                    var n,
                                        t,
                                        r = Mi(u, o, !1);
                                    return {
                                        upOrLeftCells: N(
                                            Ei(r.slice(0, (n = e)[n.length - 1].row + 1)),
                                            function (e) {
                                                return O(
                                        ...
                                        downOrRightCells: N(
                                            Ei(
                                                r.slice((t = e)[0].row + t[0].rowspan - 1, r.length)
                                            ),
                                            function (e) {
                                                return O(
                                                    e.cells.slice(
                        ...
                        ((a = Us(h)),
                        {
                            keydown: function (e, n, t, r, o, i) {
                                var u = e.raw,
                                    c = u.which,
                                    l = !0 === u.shiftKey;
                                return rr(m, g.selectedSelector).fold(
                                    function () {
                                        return (
                                            qs(c) && !l && g.clearBeforeUpdate(m),
                                            Om(c) && l
                                                ? P(Fs, a, m, d, xm, r, n, g.selectRange)
                                                : Dm(c) && l
                                                ? P(Fs, a, m, d, Rm, r, n, g.selectRange)
                                                : Om(c)
                                                ? P(_s, a, d, xm, r, n, js)
                                                : Dm(c)
                                                ? P(_s, a, d, Rm, r, n, Ws)
                            ...
                            keyup: function (c, l, a, f, s) {
                                return rr(m, g.selectedSelector).fold(function () {
                                    var t,
                                        ...
                                        n = c.raw,
                                        i = n.which;
                                    return !0 === n.shiftKey && qs(i)
                                        ? ((t = m),
                                          (r = d),
                                          (u = g.selectRange),
                                          ce((e = l), (o = f)) && a === s
                                              ? q.none()
                                              : In(e, 'td,th', r).bind(function (n) {
                ...
                I.on('dragstart', function (e) {
                    ...
                    I.on('keyup', function (e) {
                        ...
                        o.raw.shiftKey &&
                            ...
                            (t = Ve.fromDom(n.startContainer)),
                            (r = Ve.fromDom(n.endContainer)),
                    ...
                    I.on('NodeChange', function () {
                        var e = I.selection;
                        er(rt, [Ve.fromDom(e.getStart()), Ve.fromDom(e.getEnd())]).fold(
                            function () {
                                return M.clear(v);
                            },
                            E
    ...
    function Mm(o, u) {
        ...
        function e() {
            return Yl(tu(o), Zo(o)).bind(function (r) {
                return Wn(
                    rt(r),
                    Yl(Ve.fromDom(o.selection.getEnd()), Zo(o)).bind(rt),
                    function (e, n) {
                        return ce(e, n)
                            ? g(r)
                                ? q.some({
        ...
        function t(r) {
            return rt(r.element).map(function (e) {
                ...
                return { mergeable: Fi(t, r).isSome(), unmergeable: Hi(t, r).isSome(), locked: n };
            });
        }
        function r() {
            s.set(Y(e)()),
    ...
    Yr.add('table', function (c) {
        ...
        return (
            ...
            (function (n, e, t, r) {
                ...
                function u(e) {
                    n.execCommand('mceInsertTable', !1, { rows: e.numRows, columns: e.numColumns });
                }
                var i = {
                ...
                !1 === n.getParam('table_grid', !0, 'boolean')
                    ...
                    : n.ui.registry.addNestedMenuItem('inserttable', {
                          ...
                          getSubmenuItems: function () {
                              return [
                                  { type: 'fancymenuitem', fancytype: 'inserttable', onAction: u }
                              ];
                          }
                      }),
            ...
            c.on('PreInit', function () {
                c.serializer.addTempAttr(Xl.firstSelected),
                    c.serializer.addTempAttr(Xl.lastSelected),
                    c.formatter.register(Hf);
            }),
            c.getParam('table_tab_navigation', !0, 'boolean') &&
                c.on('keydown', function (e) {
                    ...
                    (n = e).keyCode === Qs.TAB &&
                        ...
                        et(Ve.fromDom(n.shiftKey ? o.startContainer : o.endContainer), r).each(
                            function (e) {
                                n.preventDefault(),
                                    rt(e, r).each(i.clear),
