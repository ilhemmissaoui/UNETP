...
!(function () {
    ...
    function V(e, t) {
        return (
            (n = fe.fromDom(e)),
            (r = t),
            0 < (o = y(n.dom.childNodes, fe.fromDom)).length && r < o.length ? B(o[r], 0) : B(n, r)
        );
        var n, r, o;
    }
    ...
    function L(e, t, n, r, o) {
        ...
        P((i = e), (a = n)) ||
            ...
            (s = new me(n, l)),
            H(e, (o ? s.next : s.prev).bind(s), n, {
                boundary: f,
                cef: f,
                text: function (e) {
                    o ? (t.fOffset += e.length) : (t.sOffset += e.length),
                        t.elements.push(fe.fromDom(e));
                }
            }));
    }
                    ...
                    var t,
                        ...
                        a = w(
                            ...
                            0 === o.childElementCount
                                ? []
                                : y(i.querySelectorAll(r), fe.fromDom)),
                            function (e) {
                                var t = e.dom;
                                return U(u, t, t);
                            }
        ...
        return (
            ...
            r
                ? ((c = e.dom),
                  ...
                  l.moveToBookmark(d),
                  h.length)
                : ((i = o), G((a = q(n, z(e.dom, g))), i), a.length)
        );
    }
    function Q(e) {
        var t = e.parentNode;
    ...
    function Y(e, t, n) {
        ...
        (n = !1 !== n)
            ...
            ? (o = r.count - 1)
            : o--,
            i.removeClass(X(e, r.index), 'mce-match-marker-selected');
        var a = X(e, o);
        return a.length
            ? (i.addClass(X(e, o), 'mce-match-marker-selected'),
    ...
    function ee(e, t, n, r, o, i) {
        var a,
            ...
            s =
                ...
                a ? '(?:^|\\s|' + E() + ')' + c + '(?=$|\\s|' + E() + ')' : c),
            f = l.isForward(),
            d = J(e, t, { regex: new RegExp(s, r ? 'g' : 'gi'), matchIndex: 1 }, i);
        return (
            N.browser.isSafari() && l.setRng(l.getRng(), f),
            d &&
                ((u = Y(e, t, !0)),
                t.set({ index: u, count: d, text: n, matchCase: r, wholeWord: o, inSelection: i })),
            d
        );
    }
    function te(e, t) {
    ...
    function oe(e, t, n, r, o) {
        ...
        r = !1 !== r;
        for (
            var l = e.getBody(), s = k.grep(k.toArray(l.getElementsByTagName('span')), re), f = 0;
            f < s.length;
            f++
        ) {
            var d = K(s[f]),
            ...
            if (o || m === a.index) {
                for (
                    n.length ? ((s[f].firstChild.nodeValue = n), Q(s[f])) : Z(e.dom, s[f]);
                    s[++f];
    ...
    function ie(i, a) {
            ...
            r.findtext.length
                ? (o.text === r.findtext &&
                  ...
                  o.wholeWord === r.wholewords
                      ? te(i, a)
                      : ((t = ee(i, a, r.findtext, r.matchcase, r.wholewords, r.inselection)) <=
                            0 &&
                            ((n = e),
        ...
        i.undoManager.add();
        var d = k.trim(i.selection.getContent({ format: 'text' })),
            m = a.get(),
            h = {
        ...
        he = function (e, t, n) {
            for (
                var r,
                    o,
                    i = t.get(),
                    a = k.toArray(e.getBody().getElementsByTagName('span')),
                    c = 0;
                c < a.length;
                c++
            ) {
    ...
    o.add('searchreplace', function (e) {
        var t,
            ...
            o,
            i,
            a = g({ index: -1, count: 0, text: '', matchCase: !1, wholeWord: !1, inSelection: !1 }),
            c = a;
        return (
