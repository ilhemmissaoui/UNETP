...
!(function () {
    ...
    function z(e, t) {
        var n,
            r,
            o,
            i = { 'Content-Type': 'application/json;charset=UTF-8', 'tiny-api-key': t };
        return F(
            ((r = t),
            (o = -1 === (n = e).indexOf('?') ? '?' : '&'),
    ...
    function ue(e, t) {
        ...
        var o = Q(e);
        return q(
            o + (-1 === o.indexOf('?') ? '?' : '&') + 'url=' + encodeURIComponent(t.src),
            e.getParam('api_key', e.getParam('imagetools_api_key', '', 'string'), 'string'),
            !1
        );
    }
    function ce(e, t) {
    ...
    var pe = tinymce.util.Tools.resolve('tinymce.util.Delay'),
        ...
        _e = function (e, t) {
            return (
                -1 !==
                f.inArray(e.getParam('imagetools_cors_hosts', [], 'string[]'), new ye(t.src).host)
            );
        };
