...
!(function () {
            ...
            for (var t = 0; t < e.length; t++) {
                var n = (function (t) {
                    ...
                    return N(r, function (e) {
                        ...
                        return (
                            n ===
                            (null === (t = e.brand) || void 0 === t ? void 0 : t.toLowerCase())
                        );
                    }).map(function (e) {
                        return { current: e.name, version: G.nu(parseInt(t.version, 10), 0) };
                    });
                })(e[t]);
            ...
            browsers: S([
                {
                    ...
                    search: function (e) {
                        return (
                            U(e, 'edge/') && U(e, 'chrome') && U(e, 'safari') && U(e, 'applewebkit')
                        );
                    }
                },
                {
    ...
    function He(e, t) {
        ...
        if (
            ...
            for (; (r = t.firstChild); ) {
                var f = r.nodeName;
                i || ('SPAN' === f && 'bookmark' === r.getAttribute('data-mce-type')) || (i = !0),
                    _e(r, s)
            ...
            o = (function (e, t, n) {
                for (var r, o, i, a = [], s = 0; s < n; s++)
                    a.push(
                        ((o = t.listType),
                        we(
                            (i = { list: me.fromTag(o, (r = e)), item: me.fromTag('li', r) }).list,
                            i.item
                        ),
                        i)
                    );
            ...
            1 === n.nodeType &&
                ...
                n.hasChildNodes()
                    ? ((r = Math.min(r, n.childNodes.length - 1)),
                      e ? n.insertBefore(t, n.childNodes[r]) : Gt.insertAfter(t, n.childNodes[r]))
                    : n.appendChild(t),
                (n = t),
                (r = 0)),
                ...
                (1 === n.nodeType &&
                    ((r = (function (e) {
                        for (var t = e.parentNode.firstChild, n = 0; t; ) {
                            if (t === e) return n;
                            (1 === t.nodeType && 'bookmark' === t.getAttribute('data-mce-type')) ||
                                n++,
                                (t = t.nextSibling);
                        }
                        return -1;
                    ...
                    (n = n.parentNode),
                    Gt.remove(t),
                    !n.hasChildNodes() && Gt.isBlock(n) && n.appendChild(Gt.create('br'))),
            ...
            (t = (function (n, e, r) {
                ...
                return (
                    Mt.each(u, function (e) {
                        ...
                        var t = e.nextSibling;
                        Zt.isBookmarkNode(e) && (Ut(t) || Ue(n, t) || (!t && e.parentNode === r))
                            ? (o = null)
                            : (o ||
                                  ((o = a.create('p')), e.parentNode.insertBefore(o, e), i.push(o)),
                              o.appendChild(e));
                    }),
                    i
                );
    ...
    function Tt(e, t, n) {
        ...
        0 < b.length
            ? ((l = e),
              ...
              (g = t),
              (v = N),
              (S = Ut((m = C))) && m.nodeName === g && !en(v)
                  ? pt(l)
                  : (Ot(l, g, v),
                    (h = gt(l.selection.getRng())),
                    (y = S
                        ? (function (e, t) {
                              for (var n, r = 0, o = t.length; r < o; r++)
                                  (!n && r in t) ||
                                      ((n = n || Array.prototype.slice.call(t, 0, r))[r] = t[r]);
                    ...
                    Mt.each(y, function (e) {
                        var t,
                            ...
                            i = v;
                        (t = e).nodeName !== o
                            ? ((n = r.dom.rename(t, o)), bt(r.dom, n, i), Ze(r, ht(o), n))
                            : (bt(r.dom, t, i), Ze(r, ht(o), t));
                    }),
                    l.selection.setRng(vt(h))))
            : ((i = t),
              (a = N),
              (o = C) !== (r = e).getBody() &&
                  (o
                      ? o.nodeName !== i || en(a) || yt(o)
                          ? ((s = gt(r.selection.getRng())),
                            ...
                            (u = r.dom.rename(o, i)),
                            Jt(r.dom, u),
                            r.selection.setRng(vt(s)),
                            Ot(r, i, a),
                            Ze(r, ht(i), u))
                          : pt(r)
                      : (Ot(r, i, a), Ze(r, ht(i), o))));
    }
    function Dt(e, t, n, r) {
        ...
        for (
            n &&
            ((s = e.dom),
            Kt((u = o)) && s.isBlock(u.nextSibling) && !Kt(u.previousSibling) && c.next());
            (o = c[n ? 'next' : 'prev2']());
                        ...
                        f
                            ? ((t = l),
                              ...
                              (u = (e = c).dom).isEmpty(r)
                                  ...
                                  : ((o = gt(t)), At(u, n, r), e.selection.setRng(vt(o))))
            ...
            !1 === e.hasPlugin('rtc', !0)
                ? ((a = e).getParam('lists_indent_on_tab', !0) &&
                  ...
                  (u = a).on('keydown', function (e) {
                      e.keyCode === he.BACKSPACE
                          ? kt(u, !1) && e.preventDefault()
                          : e.keyCode === he.DELETE && kt(u, !0) && e.preventDefault();
                  }),
