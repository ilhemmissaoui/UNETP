...
!(function () {
    ...
    function v(e) {
        return he.explode(
            e.getParam('images_file_types', 'jpeg,jpg,jpe,jfi,jif,jfif,png,gif,bmp,webp', 'string')
        );
    }
    function b(e) {
    ...
    function S(r, e) {
        ...
        var n = r.getParam(
            ...
            o = De({ valid_elements: n, valid_children: '-li[p]' });
                    ...
                    (function (r, a, o, i) {
                        ...
                        return (
                            ...
                            /(bold)/i.test(s['font-weight']) &&
                                (delete s['font-weight'], o.wrap(new Te('b', 1))),
                            /(italic)/i.test(s['font-style']) &&
                                (delete s['font-style'], o.wrap(new Te('i', 1))),
    ...
    function A(e, t, n) {
        var r,
            ...
            g = O(t),
            v = g
                ? ((a = t), (r = e).getParam('paste_enable_default_filters', !0) ? S(r, a) : a)
                : t;
        return (
            (i = n),
            (s = g),
            (p = (o = e).fire('PastePreProcess', { content: v, internal: i, wordContent: s })),
            (m = (function (e, t) {
                var n = _e({}, e.schema);
                ...
                return Ce({ validate: h(e) }, e.schema).serialize(r);
            })(o, p.content)),
            o.hasEventListeners('PastePostProcess') && !p.isDefaultPrevented()
                ? ((u = i),
                  (c = s),
                  (f = (l = o).dom.create('div', { style: 'display:none' }, m)),
                  j(
                      (d = l.fire('PastePostProcess', { node: f, internal: u, wordContent: c }))
                          .node.innerHTML,
                      d.isDefaultPrevented()
                  ))
                : j(m, p.isDefaultPrevented())
        );
    }
    function R(e, t) {
        return e.insertContent(t, { merge: e.getParam('paste_merge_formats', !0), paste: !0 }), !0;
    }
    function I(e) {
                    ...
                    pcIsSpace: !(a = function (e, t) {
                        return -1 !== ' \f\t\v'.indexOf(t) || '\xa0' === t
                            ? e.pcIsSpace ||
                              ...
                              ((n = e.str.length + 1) < i.length && 0 <= n && M(i[n]))
                                ? { pcIsSpace: !1, str: e.str + '\xa0' }
                                : { pcIsSpace: !0, str: e.str + ' ' }
                            : { pcIsSpace: M(t), str: e.str + t };
                        var n;
                    }),
                    str: ''
                }),
                            ...
                            t && w.selection.setRng(t),
                                d(e, function (e) {
                                    ...
                                    (t = w),
                                        ...
                                        (p = x),
                                        !(m = t.getParam('images_dataimg_filter')) || m(p)
                                            ? ((c = void 0),
                                              (i = (o = t.editorUpload.blobCache).getByData(v, h))
                                                  ? (c = i)
                                                  : ((l = (s =
                                                        t.getParam('images_reuse_filename') &&
                                                        P(b.name))
                                                        ? ((f = t),
                                                          P(
                                                              (d = b.name.match(
    ...
    function K(o, e, t) {
        ...
        function d(e, t, n, r, a) {
            ...
            $(t, 'text/html')
                ? (o = t['text/html'])
                : ((o = v.getHtml()), (a = a || b(o)), v.isDefaultContent(o) && (r = !0)),
                (o = k(o)),
                v.remove();
            var i,
                s,
        ...
        (s = o),
            ...
            s.on('keydown', function (e) {
                ...
                if (
                    ...
                    if ((e.stopImmediatePropagation(), c.set(e), f.set(!0), pe.ie && u))
            ...
            s.on('paste', function (e) {
                ...
                (u = !1),
                    ...
                    -1 !== navigator.userAgent.indexOf('Android') &&
                        ...
                        n.items &&
                        0 === n.items.length) ||
                    (!z(r) && U(s, e, v.getLastRng() || s.selection.getRng()))
                        ? v.remove()
                        : (t || e.preventDefault(),
                          !pe.ie ||
                              (t && !e.ieFake) ||
                          ...
                          $(r, 'text/html')
                              ? (e.preventDefault(), (o = o || b(r['text/html'])), d(s, r, t, a, o))
                              : me.setEditorTimeout(
                                    s,
                                    function () {
                                        d(s, r, t, a, o);
    ...
    function Z(s) {
        return function (e, t) {
            var n = be + e,
                r = s.dom.create('div', { contenteditable: 'false', 'data-mce-bogus': 'all' }),
    ...
    function te(e, t) {
        ...
        var n = [];
        return (
            he.each(e.schema.getBlockElements(), function (e, t) {
                n.push(t);
            }),
            (t = D(t, [
                [
        ...
        if (
            ...
            return (
                ...
                (o = e).on(
                    ...
                    function (e) {
                        G(u) &&
                            Y(e, q(u), Z(u), function () {
                                var e;
                                pe.browser.isChrome() || pe.browser.isFirefox()
                ...
                i.on('dragover dragend', function (e) {
                    T(i) && !1 === l.get() && (e.preventDefault(), Q(i, J(i, e))),
