                ...
                return (
                    ...
                    (n = (function (u) {
                            ...
                            j = {
                                ...
                                highlightElement: function (e, n, t) {
                                    ...
                                    s &&
                                        ...
                                        (s.className =
                                            s.className.replace(c, '').replace(/\s+/g, ' ') +
                                            ' language-' +
                                            a);
                                    var i,
                                        o = {
                                    ...
                                    j.hooks.run('before-highlight', o),
                                        o.grammar
                                            ? n && u.Worker
                                                ? (((i = new Worker(j.filename)).onmessage =
                                                      function (e) {
                                                          l(e.data);
                                                      }),
                                                  i.postMessage(
                        ...
                        return (
                            a &&
                                ((j.filename = a.src),
                                a.hasAttribute('data-manual') && (j.manual = !0)),
                            j.manual ||
                    ...
                    (function (t) {
                        ...
                        (t.languages.csharp = t.languages.extend('clike', {
                            string: [
                                ...
                                { pattern: RegExp(F), greedy: !0, alias: 'character' }
                            ],
                            'class-name': [
                                {
                                ...
                                'type-list': {
                                    pattern: r(
                                        /\b((?:<<0>>\s+<<1>>|record\s+<<1>>\s*<<5>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>|<<1>>\s*<<5>>|<<6>>)(?:\s*,\s*(?:<<3>>|<<4>>|<<6>>))*(?=\s*(?:where|[{;]|=>|$))/
                                            .source,
                                        [u, f, m, _, c.source, b, /\bnew\s*\(\s*\)/.source]
                                    ),
                                    lookbehind: !0,
                                    inside: {
                                        'record-arguments': {
                    ...
                    (o = /(^|[^\w.])(?:[a-z]\w*\s*\.\s*)*(?:[A-Z]\w*\s*\.\s*)*/.source),
                    (l = {
                    ...
                    Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
                        value: function (e, n) {
                            ...
                            a['language-' + n] = { pattern: /[\s\S]+/, inside: Prism.languages[n] };
                            var r = {};
                            (r[e] = {
                                pattern: RegExp(
