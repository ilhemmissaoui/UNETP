...
!(function () {
    ...
    function r(i, r) {
        ...
        return {
            ...
            add: function (e, t, n) {
                return c.push({ start: e, end: e + t, text: u.substr(e, t), data: n }), this;
            },
            wrap: function (e) {
                return (
                    c.length &&
                        (function (e, t, n) {
                            ...
                            function (e) {
                                ...
                                if (t === n) {
                                    ...
                                    return (
                                        ...
                                        e.endNodeIndex < a.length &&
                                            ((l = o.createTextNode(
                                                a.data.substring(e.endNodeIndex)
                                            )),
                                            i.insertBefore(l, a)),
                                ...
                                for (
                                    var s = o.createTextNode(t.data.substring(0, e.startNodeIndex)),
            ...
            replace: function (e, t) {
                var n = l(e);
                return (
                    n.deleteContents(), 0 < t.length && n.insertNode(r.dom.doc.createTextNode(t)), n
                );
            },
            rangeFromMatch: l,
            indexOf: a
                        ...
                        success: function (e) {
                            ...
                            n
                                ? n.error
                                    ? o(n.error)
                                    : r(n)
                                : ((t = c.translate("Server response wasn't proper JSON.")), o(t));
                        },
                        error: function () {
                            var e =
    ...
    function S(t, e, n, r, o, a) {
        t.selection.collapse(),
            a
                ? M.each(t.dom.select('span.mce-spellchecker-word'), function (e) {
    ...
    var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
        ...
        i = function (e, t, n) {
            ...
            if ((l(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get()))
        ...
        O = function (t, e, n, r, o) {
            ...
            if (
                ...
                return t.notificationManager.open({ text: c, type: 'info' }), void e.set(!1);
            }
    ...
    e.add('spellchecker', function (e, t) {
        if (
            ...
            var n = C(!1),
                r = C(
                    ((I = (P = e).getParam('language', 'en')),
                    P.getParam('spellchecker_language', I))
                ),
                o = C(null),
                a = C(null);
            return (
