...
import historyTypeSchema from '../../../../schemas/historyTypeSchema';
...
const HistoryTypes = ({ withHeader = true, withBody = true, withFooter = true }) => {
    const addForm = useForm({
        resolver: yupResolver(historyTypeSchema)
    });
    const crud = useCRUD({
            ...
            <CRUDProvider {...crud}>
                    ...
                    <div className="card-header border-0 pt-6">
                        ...
                        <div className="card-toolbar">
                            <Ability I="create" an="history-type">
                                <button className="btn btn-primary btn-sm" onClick={toggleIsAdd}>
                                    {' '}
                ...
                <FormProvider {...addForm}>
                    <Add
                        ...
                        label="HistoryTypes"
                        formId="add-historyTypes"
                        singleName="historyTypes"
                        collectionLabelPrefix="d'un"
                        collectionLabel="type d'historique"
                        size="lg"
                        doReset={false}>
                        <form id="add-historyTypes">
                            <Form />
                        </form>
                    </Add>
                </FormProvider>
