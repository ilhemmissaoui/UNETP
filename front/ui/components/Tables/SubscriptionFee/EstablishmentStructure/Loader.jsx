        ...
        <tbody>
            {new Array(rows).fill(0).map((e, i) => (
                <tr key={i}>
                    ...
                    <td>
                        <ContentLoader width="180" height="13">
                            <rect x="0" y="0" width="180" height="13" />
                        </ContentLoader>
                    </td>
                    <td>
                    ...
                    <td>
                        <ContentLoader width="70" height="13" className="rounded">
                            <rect x="0" y="0" width="70" height="13" />
                        </ContentLoader>
                    </td>
                    <td>
                        <ContentLoader width="80" height="20" className="rounded">
                            <rect x="0" y="0" width="80" height="20" />
                        </ContentLoader>
                    </td>
                    <td>
                        <ContentLoader width="60" height="20" className="rounded">
