...
const Specialties = ({ withHeader = true, withBody = true, withFooter = true }) => {
            ...
            <CRUDProvider {...crud}>
                {withHeader && (
                    <div className="card-header border-0 pt-6">
                        ...
                        <div className="card-toolbar">
                            <Ability I="create" an="diploma.specialty">
                ...
                <FormProvider {...addForm}>
                    <Add
                        ...
                        label="Specialty"
                        formId="add-specialty"
                        collectionLabelPrefix="d'une"
                        singleName="specialty"
                        collectionLabel="Spécialité"
                        size="lg"
                        doReset={false}>
                        <form id="add-specialty">
                            <Form />
                        </form>
                    </Add>
                </FormProvider>
