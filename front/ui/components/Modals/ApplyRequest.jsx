...
const ApplyRequest = ({
    ...
    const submit = async () => {
        ...
        try {
            await axios.post(`${endpointUrl}/request-change/apply/${id}`, {
                acceptedFields,
                organizationId
            });
            setToast({
                message: 'Demande a été appliqué avec succès',
                variant: 'success'
            });
            toggleIsShow();
        } catch (e) {
            ...
            setToast({
                message: "Erreur lors de l'application de la demande",
                variant: 'danger'
            });
        }
    ...
    return (
        <Modal show={isShow} onHide={toggleIsShow} size={size}>
            ...
            <Modal.Body>
                ...
                Etes-vous sûr que vous voulez appliquer <b>Ces modifications</b> ?
            </Modal.Body>
            <Modal.Footer>
