...
import GlobalInfo from '../../ui/components/Office/components/GlobalInfo';
import Histories from '../../ui/components/Office/components/histories';
import Users from '../../ui/components/Office/components/Users';
...
const Office = () => {
    ...
    return (
        <Layout>
            <Head>
                <title>Gestion des bureaux | {process.env.platformName} </title>
            </Head>
